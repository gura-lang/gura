...
//----------------------------------------------------------------------------
class Object_wx_RichTextAttr : public Object {
protected:
	wxRichTextAttr *_pEntity;
...
public:
	inline Object_wx_RichTextAttr(wxRichTextAttr *pEntity, GuraObjectObserver *pObserver, bool ownerFlag) :
				Object(Gura_UserClass(wx_RichTextAttr)),
	...
	inline void SetEntity(wxRichTextAttr *pEntity, GuraObjectObserver *pObserver, bool ownerFlag) {
	...
	inline wxRichTextAttr *GetEntity() { return _pEntity; }
