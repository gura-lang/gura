...
Gura_ImplementFunction(MessageDialog)
{
	...
	Object_wx_MessageDialog *pObj = Object_wx_MessageDialog::GetObjectThis(arg);
	if (pObj == nullptr) {
...
Gura_ImplementMethod(wx_MessageDialog, SetExtendedMessage)
{
	...
	wxString extendedMessage = wxString::FromUTF8(arg.GetString(0));
...
Gura_ImplementMethod(wx_MessageDialog, SetHelpLabel)
{
	...
	Object_wx_MessageDialog *pThis = Object_wx_MessageDialog::GetObjectThis(arg);
	if (pThis->IsInvalid(sig)) return Value::Nil;
	wxString help = wxString::FromUTF8(arg.GetString(0));
...
Gura_ImplementMethod(wx_MessageDialog, SetOKCancelLabels)
{
	...
	Object_wx_MessageDialog *pThis = Object_wx_MessageDialog::GetObjectThis(arg);
	if (pThis->IsInvalid(sig)) return Value::Nil;
	wxString ok = wxString::FromUTF8(arg.GetString(0));
	wxString cancel = wxString::FromUTF8(arg.GetString(1));
...
Gura_ImplementMethod(wx_MessageDialog, SetYesNoCancelLabels)
{
	...
	Object_wx_MessageDialog *pThis = Object_wx_MessageDialog::GetObjectThis(arg);
	if (pThis->IsInvalid(sig)) return Value::Nil;
	wxString yes = wxString::FromUTF8(arg.GetString(0));
	wxString no = wxString::FromUTF8(arg.GetString(1));
	wxString cancel = wxString::FromUTF8(arg.GetString(2));
