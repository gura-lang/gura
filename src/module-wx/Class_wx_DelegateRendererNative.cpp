...
public:
	inline wx_DelegateRendererNative() : wxDelegateRendererNative(), _pSig(nullptr), _pObj(nullptr) {}
	inline wx_DelegateRendererNative(wxRendererNative& rendererNative) : wxDelegateRendererNative(rendererNative), _pSig(nullptr), _pObj(nullptr) {}
