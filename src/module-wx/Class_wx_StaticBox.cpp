...
public:
	inline wx_StaticBox() : wxStaticBox(), _pSig(nullptr), _pObj(nullptr) {}
	inline wx_StaticBox(wxWindow* parent, wxWindowID id, const wxString& label, const wxPoint& pos, const wxSize& size, long style, const wxString& name) : wxStaticBox(parent, id, label, pos, size, style, name), _pSig(nullptr), _pObj(nullptr) {}
	~wx_StaticBox();
