...
public:
	inline wx_TCPConnection() : wxTCPConnection(), _pSig(nullptr), _pObj(nullptr) {}
	//inline wx_TCPConnection(char* buffer, int size) : wxTCPConnection(buffer, size), _pSig(nullptr), _pObj(nullptr) {}
...
{
#if 0
	Object_wx_TCPConnection *pThis = Object_wx_TCPConnection::GetThisObj(args);
