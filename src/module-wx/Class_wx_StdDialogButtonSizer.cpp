...
Gura_ImplementFunction(StdDialogButtonSizer)
{
	...
	Object_wx_StdDialogButtonSizer *pObj = Object_wx_StdDialogButtonSizer::GetObjectThis(args);
	if (pObj == nullptr) {
...
{
	Signal &sig = env.GetSignal();
	Object_wx_StdDialogButtonSizer *pThis = Object_wx_StdDialogButtonSizer::GetObjectThis(args);
