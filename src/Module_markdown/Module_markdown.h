...
private:
	enum Stat {
		...
		STAT_ListItem,
		STAT_ListItemPost,
		STAT_ListItemPost_Asterisk,
		STAT_ListItemPost_Plus,
		STAT_ListItemPost_Hyphen,
		STAT_ListItemPost_Digit,
		STAT_ListItemPost_DigitDot,
		STAT_ListItemPostNL,
		STAT_ListItemPostNL_Asterisk,
		STAT_ListItemPostNL_Plus,
		STAT_ListItemPostNL_Hyphen,
		STAT_ListItemPostNL_Digit,
		STAT_ListItemPostNL_DigitDot,
		STAT_Block,
		STAT_Block_LineTop,
		STAT_BlockInListItem,
		STAT_BlockInListItem_LineTop,
		STAT_Backquote,
		STAT_Code,
		STAT_CodeEsc,
