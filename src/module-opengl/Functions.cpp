...
Gura_ImplementFunction(__glAreTexturesResident)
{
	...
	AutoPtr<ArrayT<GLboolean> > _residences(ArrayT<GLboolean>::Create(false, n));
...
Gura_ImplementFunction(__glGenTextures)
{
	...
	AutoPtr<ArrayT<GLuint> > _textures(ArrayT<GLuint>::Create(false, n));
...
Gura_ImplementFunction(__glGetBooleanv)
{
	...
	AutoPtr<ArrayT<GLboolean> > _params(ArrayT<GLboolean>::Create(false, n));
...
Gura_ImplementFunction(__glGetColorTableParameterfv)
{
	...
	GLenum pname = static_cast<GLenum>(arg.GetInt(1));
	size_t n = GetParamCount(pname);
	AutoPtr<ArrayT<GLfloat> > _params(ArrayT<GLfloat>::Create(false, n));
...
Gura_ImplementFunction(__glGetColorTableParameteriv)
{
	...
	GLenum pname = static_cast<GLenum>(arg.GetInt(1));
	size_t n = GetParamCount(pname);
	AutoPtr<ArrayT<GLint> > _params(ArrayT<GLint>::Create(false, n));
...
Gura_ImplementFunction(__glGetDoublev)
{
	GLenum pname = static_cast<GLenum>(arg.GetInt(0));
	size_t n = GetParamCount(pname);
	AutoPtr<ArrayT<GLdouble> > _params(ArrayT<GLdouble>::Create(false, n));
...
{
	AutoPtr<ArrayT<UInt8> > pArrayT(ArrayT<UInt8>::Create(false, 32 * 4));
...
Gura_ImplementFunction(__glGenQueries)
{
	...
	ImplementGLExtension();
	GLsizei n = arg.GetInt(0);
	AutoPtr<ArrayT<GLuint> > _ids(ArrayT<GLuint>::Create(false, n));
...
Gura_ImplementFunction(__glGetQueryObjectuiv)
{
	...
	GLenum pname = static_cast<GLenum>(arg.GetInt(1));
	size_t n = GetParamCount(pname);
	AutoPtr<ArrayT<GLuint> > _params(ArrayT<GLuint>::Create(false, n));
...
Gura_ImplementFunction(__glGenBuffers)
{
	...
	ImplementGLExtension();
	GLsizei n = arg.GetInt(0);
	AutoPtr<ArrayT<GLuint> > _buffers(ArrayT<GLuint>::Create(false, n));
