...
bool Object_DisplayMode::DoDirProp(Environment &env, Signal &__to_delete__, SymbolSet &symbols)
{
...
Value Object_DisplayMode::DoGetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol,
...
Value Object_DisplayMode::DoSetProp(Environment &env, Signal &__to_delete__,
