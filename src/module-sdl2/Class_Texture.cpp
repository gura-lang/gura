...
bool Object_Texture::DoDirProp(Environment &env, SymbolSet &symbols)
{
	return true;
}

Value Object_Texture::DoGetProp(Environment &env, const Symbol *pSymbol,
...
Value Object_Texture::DoSetProp(Environment &env,
