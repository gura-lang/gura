...
bool Object_Cursor::DoDirProp(Environment &env, Signal &__to_delete__, SymbolSet &symbols)
{
	return true;
}

Value Object_Cursor::DoGetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol,
...
Value Object_Cursor::DoSetProp(Environment &env, Signal &__to_delete__,
