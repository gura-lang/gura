...
String Object_FTC_Node::ToString(Signal sig, bool exprFlag)
{
	char buff[80];
...
bool Object_FTC_Node::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_FTC_Node::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_FTC_Node::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
