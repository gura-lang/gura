...
bool Object_Bitmap::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_Bitmap::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_Bitmap::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
