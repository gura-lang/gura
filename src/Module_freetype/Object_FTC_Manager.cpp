...
bool Object_FTC_Manager::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_FTC_Manager::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_FTC_Manager::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
