...
String Object_FTC_CMapCache::ToString(Signal sig, bool exprFlag)
{
	char buff[80];
...
bool Object_FTC_CMapCache::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_FTC_CMapCache::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_FTC_CMapCache::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
