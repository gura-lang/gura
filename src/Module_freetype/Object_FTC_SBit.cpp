...
bool Object_FTC_SBit::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_FTC_SBit::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_FTC_SBit::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
