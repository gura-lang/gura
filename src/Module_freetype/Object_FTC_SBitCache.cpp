...
bool Object_FTC_SBitCache::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_FTC_SBitCache::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_FTC_SBitCache::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
