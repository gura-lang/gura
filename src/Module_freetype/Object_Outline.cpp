...
bool Object_Outline::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_Outline::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_Outline::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
