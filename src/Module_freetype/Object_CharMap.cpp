...
bool Object_CharMap::DoDirProp(Signal sig, SymbolSet &symbols)
{
...
Value Object_CharMap::DoGetProp(Signal sig, const Symbol *pSymbol,
...
Value Object_CharMap::DoSetProp(Signal sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
