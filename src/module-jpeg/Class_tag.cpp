...
bool Object_tag::DoDirProp(Environment &env, Signal &__to_delete__, SymbolSet &symbols)
{
...
Value Object_tag::DoGetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol,
