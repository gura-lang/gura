...
Gura_DeclareMethod(list, clear)
{
	...
	AddHelp(Gura_Symbol(en), SYN_markdown, "Clear the content of the list.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Return true if the list is empty.");
}
...
{
	SetMode(RSLTMODE_Reduce, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Shuffle the order of the list content based on random numbers.");
}
...
Gura_DeclareMethod(list, add)
{
	...
	AddHelp(Gura_Symbol(en), SYN_markdown, "Add specified items to the list.");
}
...
Gura_DeclareMethod(list, insert)
{
	...
	DeclareArg(env, "elem", VTYPE_any, OCCUR_OnceOrMore);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Insert specified items to the list from the selected index.");
}
...
Gura_DeclareMethod(list, erase)
{
	...
	AddHelp(Gura_Symbol(en), SYN_markdown, "Erases elements at the specified indices.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns the flattened list.");
}
...
Gura_DeclareMethod(list, printf)
{
	...
	AddHelp(Gura_Symbol(en), SYN_markdown, "Prints items in the list by using the format.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns the length of the list.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns a sum of values in the list.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns an average of values in the list.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns a variance of values in the list.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), SYN_markdown, "Returns a standard deviation of values in the list.");
}
