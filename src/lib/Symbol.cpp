...
void SymbolPool::_Initialize()
{
	...
	Gura_RealizeSymbol(light_blue);
	Gura_RealizeSymbol(light_green);
	Gura_RealizeSymbol(light_aqua);
	Gura_RealizeSymbol(light_red);
	Gura_RealizeSymbol(light_purple);
	Gura_RealizeSymbol(light_yellow);
