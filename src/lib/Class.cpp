...
// ClassPrimitive
//-----------------------------------------------------------------------------
Value ClassPrimitive::EvalIndexGetOnValue(Environment &env,
...
void ClassPrimitive::EvalIndexSetOnValue(Environment &env, const Value &valueThis,
...
// ClassFundamental
//-----------------------------------------------------------------------------
Value ClassFundamental::EvalIndexGetOnValue(Environment &env,
									 const Value &valueThis, const ValueList &valListIdx) const
{
	return valueThis.GetFundamental()->EvalIndexGet(env, valListIdx);
}

void ClassFundamental::EvalIndexSetOnValue(Environment &env, const Value &valueThis,
									const ValueList &valListIdx, const Value &value) const
{
