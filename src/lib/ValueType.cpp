...
ValueType VTYPE_gear_at_averagepool1d	= static_cast<ValueType>(0);
ValueType VTYPE_gear_at_averagepool2d	= static_cast<ValueType>(0);
ValueType VTYPE_gear_at_averagepool3d	= static_cast<ValueType>(0);
...
void ValueTypePool::_Bootup(Environment &env)
{
	...
	Gura_RealizeVTYPEAlias(gear_at_averagepool1d,	"gear@averagepool1d");
	Gura_RealizeVTYPEAlias(gear_at_averagepool2d,	"gear@averagepool2d");
	Gura_RealizeVTYPEAlias(gear_at_averagepool3d,	"gear@averagepool3d");
	...
	Gura_VTYPEInfo(gear_at_averagepool1d)->SetClass(new Class_gear_at_averagepool1d(pClass_gear));
	Gura_VTYPEInfo(gear_at_averagepool2d)->SetClass(new Class_gear_at_averagepool2d(pClass_gear));
	Gura_VTYPEInfo(gear_at_averagepool3d)->SetClass(new Class_gear_at_averagepool3d(pClass_gear));
...
void ValueTypePool::DoPrepareClass(Environment &env)
{
	...
	env.LookupClass(VTYPE_gear_at_averagepool1d	)->Prepare(env);
	env.LookupClass(VTYPE_gear_at_averagepool2d	)->Prepare(env);
	env.LookupClass(VTYPE_gear_at_averagepool3d	)->Prepare(env);
