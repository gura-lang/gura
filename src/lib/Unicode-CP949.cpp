...
//-----------------------------------------------------------------------------
// convert table between CP949 and UTF16
// http://www.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/WINDOWS/CP949.TXT
//-----------------------------------------------------------------------------
static const UShort _row_00[] = {
...
static const CodeRow _codeRows[] = {
	...
	{   0,     NULL }, {   0,     NULL }, {   0,     NULL }, {   0,     NULL },
	{   0,     NULL }, {   0,     NULL }, {   0,     NULL }, {   0,     NULL },
	{   0,     NULL }, { 191,  _row_81 }, { 191,  _row_82 }, { 191,  _row_83 },
	{ 191,  _row_84 }, { 191,  _row_85 }, { 191,  _row_86 }, { 191,  _row_87 },
	{ 191,  _row_88 }, { 191,  _row_89 }, { 191,  _row_8A }, { 191,  _row_8B },
	{ 191,  _row_8C }, { 191,  _row_8D }, { 191,  _row_8E }, { 191,  _row_8F },
	{ 191,  _row_90 }, { 191,  _row_91 }, { 191,  _row_92 }, { 191,  _row_93 },
	{ 191,  _row_94 }, { 191,  _row_95 }, { 191,  _row_96 }, { 191,  _row_97 },
	{ 191,  _row_98 }, { 191,  _row_99 }, { 191,  _row_9A }, { 191,  _row_9B },
	{ 191,  _row_9C }, { 191,  _row_9D }, { 191,  _row_9E }, { 191,  _row_9F },
	{ 191,  _row_A0 }, { 191,  _row_A1 }, { 168,  _row_A2 }, { 191,  _row_A3 },
	{ 191,  _row_A4 }, { 185,  _row_A5 }, { 165,  _row_A6 }, { 176,  _row_A7 },
	{ 191,  _row_A8 }, { 191,  _row_A9 }, { 180,  _row_AA }, { 183,  _row_AB },
	{ 178,  _row_AC }, {  97,  _row_AD }, {  97,  _row_AE }, {  97,  _row_AF },
	{ 191,  _row_B0 }, { 191,  _row_B1 }, { 191,  _row_B2 }, { 191,  _row_B3 },
	{ 191,  _row_B4 }, { 191,  _row_B5 }, { 191,  _row_B6 }, { 191,  _row_B7 },
	{ 191,  _row_B8 }, { 191,  _row_B9 }, { 191,  _row_BA }, { 191,  _row_BB },
	{ 191,  _row_BC }, { 191,  _row_BD }, { 191,  _row_BE }, { 191,  _row_BF },
	{ 191,  _row_C0 }, { 191,  _row_C1 }, { 191,  _row_C2 }, { 191,  _row_C3 },
	{ 191,  _row_C4 }, { 191,  _row_C5 }, { 191,  _row_C6 }, { 191,  _row_C7 },
	{ 191,  _row_C8 }, {   0,     NULL }, { 191,  _row_CA }, { 191,  _row_CB },
	{ 191,  _row_CC }, { 191,  _row_CD }, { 191,  _row_CE }, { 191,  _row_CF },
	{ 191,  _row_D0 }, { 191,  _row_D1 }, { 191,  _row_D2 }, { 191,  _row_D3 },
	{ 191,  _row_D4 }, { 191,  _row_D5 }, { 191,  _row_D6 }, { 191,  _row_D7 },
	{ 191,  _row_D8 }, { 191,  _row_D9 }, { 191,  _row_DA }, { 191,  _row_DB },
	{ 191,  _row_DC }, { 191,  _row_DD }, { 191,  _row_DE }, { 191,  _row_DF },
	{ 191,  _row_E0 }, { 191,  _row_E1 }, { 191,  _row_E2 }, { 191,  _row_E3 },
	{ 191,  _row_E4 }, { 191,  _row_E5 }, { 191,  _row_E6 }, { 191,  _row_E7 },
	{ 191,  _row_E8 }, { 191,  _row_E9 }, { 191,  _row_EA }, { 191,  _row_EB },
	{ 191,  _row_EC }, { 191,  _row_ED }, { 191,  _row_EE }, { 191,  _row_EF },
	{ 191,  _row_F0 }, { 191,  _row_F1 }, { 191,  _row_F2 }, { 191,  _row_F3 },
	{ 191,  _row_F4 }, { 191,  _row_F5 }, { 191,  _row_F6 }, { 191,  _row_F7 },
	{ 191,  _row_F8 }, { 191,  _row_F9 }, { 191,  _row_FA }, { 191,  _row_FB },
	{ 191,  _row_FC }, { 191,  _row_FD }, {   0,     NULL }, {   0,     NULL },
};

UShort CP949ToUTF16(UShort codeCP949)
{
	int codeH = (codeCP949 >> 8) & 0xff;
	int codeL = codeCP949 & 0xff;
...
UShort UTF16ToCP949(UShort codeUTF16)
{
	...
	if (pMap == NULL) {
		...
		for (int codeL = 0; codeL < pCodeRow->nCols; codeL++) {
			...
			UShort codeCP949 = static_cast<UShort>(codeL);
			if (pMap->find(codeUTF16) == pMap->end()) {
				(*pMap)[codeUTF16] = codeCP949;
			}
		}
		pCodeRow++;
		for (int codeH = 1; codeH < ArraySizeOf(_codeRows); codeH++, pCodeRow++) {
			UShort codeCP949Base = static_cast<UShort>(codeH << 8);
			for (int iCol = 0; iCol < pCodeRow->nCols; iCol++) {
				...
				UShort codeCP949 = codeCP949Base + codeL;
				//printf("%04x -> %04x\n", codeUTF16, codeCP949);
				if (pMap->find(codeUTF16) == pMap->end()) {
					(*pMap)[codeUTF16] = codeCP949;
				}
