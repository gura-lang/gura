...
Gura_DeclareClassMethod(binary, pack)
{
	...
	AddHelp(
		...
		"\n"
		"Following format characters are used to pack a `number` value specified in\n"
		"the argument list into a binary sequence.\n"
		"\n"
		...
		"Below is an example to pack four `number` values into a binary\n"
		"as two-byte unsigned numbers:\n"
		"\n"
		"    buff = binary.pack('4H', 1, 2, 3, 4)\n"
		"\n"
		"- `x` .. Packs no values and fills with zero.\n"
		"- `s` .. Packs UTF-8 character codes in `string`.\n"
		"- `c` .. Packs the first byte in `string` as a one-byte number.\n"
		"\n"
		"\n"
		...
		"You can change it with the following specifiers:\n"
		"\n"
		...
		"- `!` .. Big endian\n"
		"\n"
		"You can specify an asterisk character \"`*`\" for the number of values\n"
