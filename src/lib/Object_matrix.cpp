...
Gura_DeclareMethod(matrix, set)
{
	...
	AddHelp(Gura_Symbol(en), FMT_markdown, "Sets all the cells of the matrix with a specified value.");
}
...
Gura_DeclareMethod(matrix, setrow)
{
	...
	DeclareArg(env, "value", VTYPE_any);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Sets cells in a selected row of the matrix with a specified value.");
}
...
Gura_DeclareMethod(matrix, setcol)
{
	...
	DeclareArg(env, "value", VTYPE_any);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Sets cells in a selected column of the matrix with a specified value.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns the matrix row size.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns the matrix column size.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns true if the matrix is a square one.");
}
...
Gura_DeclareMethod(matrix, roundoff)
{
	...
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns a matrix with values that have been rounded off.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns a transpose matrix.");
}
...
{
	SetMode(RSLTMODE_Normal, FLAG_None);
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns an inverted matrix.");
}
