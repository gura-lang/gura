...
//#cairo_font_face_t *cairo_toy_font_face_create_for_ft_face(FT_Face face, int load_flags);
//#cairo_font_face_t *cairo_toy_font_face_create_for_pattern(FcPattern *pattern);
...
//#unsigned int cairo_toy_font_face_get_synthesize(cairo_font_face_t *font_face);
//#void cairo_toy_font_face_set_synthesize(cairo_font_face_t *font_face, unsigned int synth_flags);
//#void cairo_toy_font_face_unset_synthesize (cairo_font_face_t *font_face, unsigned int synth_flags);
