...
bool Object_BDF_Property::DoDirProp(Environment &env, Signal &sig, SymbolSet &symbols)
{
...
Value Object_BDF_Property::DoGetProp(Environment &env, Signal &sig, const Symbol *pSymbol,
...
Value Object_BDF_Property::DoSetProp(Environment &env, Signal &sig, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	evaluatedFlag = true;
#if 0
