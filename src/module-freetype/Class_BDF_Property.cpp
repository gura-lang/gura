...
bool Object_BDF_Property::DoDirProp(Environment &env, SymbolSet &symbols)
{
...
Value Object_BDF_Property::DoGetProp(Environment &env, const Symbol *pSymbol,
...
Value Object_BDF_Property::DoSetProp(Environment &env, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	Signal &sig = GetSignal();
	evaluatedFlag = true;
