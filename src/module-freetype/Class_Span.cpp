...
bool Object_Span::DoDirProp(Environment &env, Signal &__to_delete__, SymbolSet &symbols)
{
...
Value Object_Span::DoGetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol,
...
Value Object_Span::DoSetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	Signal &sig = GetSignal();
	evaluatedFlag = true;
