...
bool Object_FTC_ImageCache::DoDirProp(Environment &env, SymbolSet &symbols)
{
...
Value Object_FTC_ImageCache::DoGetProp(Environment &env, const Symbol *pSymbol,
...
Value Object_FTC_ImageCache::DoSetProp(Environment &env, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	Signal &sig = GetSignal();
	evaluatedFlag = true;
