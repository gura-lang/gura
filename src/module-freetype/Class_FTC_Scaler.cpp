...
bool Object_FTC_Scaler::DoDirProp(Environment &env, Signal &__to_delete__, SymbolSet &symbols)
{
...
Value Object_FTC_Scaler::DoGetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol,
...
Value Object_FTC_Scaler::DoSetProp(Environment &env, Signal &__to_delete__, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	Signal &sig = GetSignal();
	evaluatedFlag = true;
