...
bool Object_FTC_CMapCache::DoDirProp(Environment &env, SymbolSet &symbols)
{
...
Value Object_FTC_CMapCache::DoGetProp(Environment &env, const Symbol *pSymbol,
...
Value Object_FTC_CMapCache::DoSetProp(Environment &env, const Symbol *pSymbol, const Value &value,
							const SymbolSet &attrs, bool &evaluatedFlag)
{
	Signal &sig = GetSignal();
	evaluatedFlag = true;
