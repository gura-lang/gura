...
Gura_DeclareFunction(exists)
{
	...
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns true if the specified file exists in a file system.");
}
...
Gura_DeclareFunction(absname)
{
	...
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns an absolute path name of the given name.");
}
...
Gura_DeclareFunction(regulate)
{
	...
	DeclareArg(env, "name", VTYPE_string);
	DeclareAttr(Gura_Symbol(uri));
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns a regulated path name of the given name.");
}
...
Gura_DeclareFunction(join)
{
	...
	DeclareAttr(Gura_Symbol(uri));
	AddHelp(Gura_Symbol(en), FMT_markdown, "Returns a path name that joins given strings with directory separators.");
}
