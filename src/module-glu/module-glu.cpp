...
void Object_Quadric::_CB_error(GLenum err_no, const Function *pFunc)
{
	...
	if (!pArg->AddValue(env, Value(static_cast<int>(err_no)))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Tesselator::_CB_begin(GLenum type, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value(static_cast<int>(type)))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Tesselator::_CB_edge_flag(GLboolean flag, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value(flag == GL_TRUE))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Tesselator::_CB_vertex(void *vertex_data, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, reinterpret_cast<VertexPack *>(vertex_data)->GetVertexData())) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Tesselator::_CB_error(GLenum err_no, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value(err_no))) return;
	pFunc->Eval(env, *pArg);
}
						...
						GLfloat weight[4], void **outData, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value::CreateList(env, coords, 3))) return;
	do {
		Value value;
	...
	if (!pArg->AddValue(env, Value::CreateList(env, weight, 4))) return;
...
void Object_Tesselator::_CB_begin_data(GLenum type, void *polygon_data, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValues(env,
		Value(type),
		reinterpret_cast<PolygonPack *>(polygon_data)->GetPolygonData())) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Tesselator::_CB_end_data(void *polygon_data, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, reinterpret_cast<PolygonPack *>(polygon_data)->GetPolygonData())) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_begin(GLenum type, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value(type))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_vertex(GLfloat *vertex, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value::CreateList(env, vertex, 3))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_normal(GLfloat *normal, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value::CreateList(env, normal, 3))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_color(GLfloat *color, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value::CreateList(env, color, 4))) return;
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_texture_coord(GLfloat *tex_coord, const Function *pFunc)
{
	...
	Environment &env = pFunc->GetEnvScope();
	AutoPtr<Argument> pArg(new Argument(pFunc));
	if (!pArg->AddValue(env, Value::CreateList(env, tex_coord, 4))) return; // 1, 2, 3, 4
	pFunc->Eval(env, *pArg);
}
...
void Object_Nurbs::_CB_begin_data(GLenum type, void *userData, const Function *pFunc)
{
	...
	if (!pArg->AddValues(env,
		Value(type),
		reinterpret_cast<Object_Nurbs *>(userData)->GetCallbackData())) return;
	pFunc->Eval(env, *pArg);
}
