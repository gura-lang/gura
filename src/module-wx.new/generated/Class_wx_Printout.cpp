...
Gura_ImplementMethod(wx_Printout, __GetLogicalPageMarginsRect)
{
	...
	//pThis->GetEntity()->GetLogicalPageMarginsRect(pageSetupData);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_Printout, __HasPage)
{
	...
	//pThis->GetEntity()->HasPage(pageNum);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_Printout, __OnBeginDocument)
{
	...
	//pThis->GetEntity()->OnBeginDocument(startPage, endPage);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_Printout, __OnPrintPage)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int pageNum = arg.GetNumber(0)
	//pThis->GetEntity()->OnPrintPage(pageNum);
	return Value::Nil;
}
