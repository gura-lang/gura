...
Gura_ImplementMethod(wx_AuiToolBar, __AddTool)
{
	...
	//pThis->GetEntity()->AddTool(tool_id, label, bitmap, short_help_string, kind);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __AddTool_1)
{
	...
	//pThis->GetEntity()->AddTool(tool_id, label, bitmap, disabled_bitmap, kind, short_help_string, long_help_string, client_data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __AddTool_2)
{
	...
	//const wxString& short_help_string = arg.GetNumber(5)
	//const wxString& long_help_string = arg.GetNumber(6)
	//pThis->GetEntity()->AddTool(tool_id, bitmap, disabled_bitmap, toggle, client_data, short_help_string, long_help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __AddLabel)
{
	...
	//pThis->GetEntity()->AddLabel(tool_id, label, width);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __AddSpacer)
{
	...
	//pThis->GetEntity()->AddSpacer(pixels);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __AddStretchSpacer)
{
	...
	//pThis->GetEntity()->AddStretchSpacer(proportion);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __FindControl)
{
	...
	//pThis->GetEntity()->FindControl(window_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __FindToolByPosition)
{
	...
	//pThis->GetEntity()->FindToolByPosition(x, y);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __FindToolByIndex)
{
	...
	//pThis->GetEntity()->FindToolByIndex(idx);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __FindTool)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->FindTool(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __DeleteTool)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->DeleteTool(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __DeleteByIndex)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->DeleteByIndex(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolPos)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolPos(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolIndex)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolIndex(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolFits)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolFits(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolRect)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolRect(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolFitsByIndex)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolFitsByIndex(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolToggled)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolToggled(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolEnabled)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolEnabled(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolDropDown)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolDropDown(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolProportion)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolProportion(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolSticky)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolSticky(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolLabel)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolLabel(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolBitmap)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolBitmap(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolShortHelp)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolShortHelp(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetToolLongHelp)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolLongHelp(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __GetHintSize)
{
	...
	//pThis->GetEntity()->GetHintSize(dock_direction);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_AuiToolBar, __IsPaneValid)
{
	...
	//pThis->GetEntity()->IsPaneValid(pane);
	return Value::Nil;
}
