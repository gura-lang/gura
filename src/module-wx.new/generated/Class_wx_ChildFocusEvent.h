...
// wxChildFocusEvent
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_CHILDFOCUSEVENT_H__
#define __CLASS_WX_CHILDFOCUSEVENT_H__
#include <wx/event.h>
...
public:
	...
	inline wxChildFocusEvent *GetEntity() {
		return static_cast<wxChildFocusEvent *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxChildFocusEvent");
		return true;
	}
};
