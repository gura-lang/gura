...
Gura_ImplementMethod(wx_PropertyGrid, __AddActionTrigger)
{
	...
	//pThis->GetEntity()->AddActionTrigger(action, keycode, modifiers);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __AddToSelection)
{
	...
	//bool _rtn = pThis->GetEntity()->AddToSelection(id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __AutoGetTranslation)
{
	...
	//pThis->GetEntity()->AutoGetTranslation(enable);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __BeginLabelEdit)
{
	...
	//pThis->GetEntity()->BeginLabelEdit(colIndex);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __ChangePropertyValue)
{
	...
	//bool _rtn = pThis->GetEntity()->ChangePropertyValue(id, newValue);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __CenterSplitter)
{
	...
	//pThis->GetEntity()->CenterSplitter(enableAutoResizing);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __ClearActionTriggers)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int action = arg.GetNumber(0)
	//pThis->GetEntity()->ClearActionTriggers(action);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __DedicateKey)
{
	...
	//pThis->GetEntity()->DedicateKey(keycode);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __EndLabelEdit)
{
	...
	//pThis->GetEntity()->EndLabelEdit(commit);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __FitColumns)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSize _rtn = pThis->GetEntity()->FitColumns();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetLabelEditor)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTextCtrl* _rtn = pThis->GetEntity()->GetLabelEditor();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetPanel)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWindow* _rtn = pThis->GetEntity()->GetPanel();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCaptionBackgroundColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetCaptionBackgroundColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCaptionFont)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxFont& _rtn = pThis->GetEntity()->GetCaptionFont();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCaptionForegroundColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetCaptionForegroundColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCellBackgroundColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetCellBackgroundColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCellDisabledTextColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetCellDisabledTextColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetCellTextColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetCellTextColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetEmptySpaceColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetEmptySpaceColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetFontHeight)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int _rtn = pThis->GetEntity()->GetFontHeight();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetImageRect)
{
	...
	//wxRect _rtn = pThis->GetEntity()->GetImageRect(property, item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetImageSize)
{
	...
	//wxPGProperty* property = arg.GetNumber(0)
	//int item = arg.GetNumber(1)
	//wxSize _rtn = pThis->GetEntity()->GetImageSize(property, item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetLastItem)
{
	...
	//wxPGProperty* _rtn = pThis->GetEntity()->GetLastItem(flags);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetLineColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetLineColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetMarginColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetMarginColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetRoot)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxPGProperty* _rtn = pThis->GetEntity()->GetRoot();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetRowHeight)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int _rtn = pThis->GetEntity()->GetRowHeight();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetSelectionBackgroundColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetSelectionBackgroundColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetSelectionForegroundColour)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxColour _rtn = pThis->GetEntity()->GetSelectionForegroundColour();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetSortFunction)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxPGSortCallback _rtn = pThis->GetEntity()->GetSortFunction();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetSplitterPosition)
{
	...
	//int _rtn = pThis->GetEntity()->GetSplitterPosition(splitterIndex);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetEditorTextCtrl)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTextCtrl* _rtn = pThis->GetEntity()->GetEditorTextCtrl();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetUnspecifiedValueAppearance)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxPGCell& _rtn = pThis->GetEntity()->GetUnspecifiedValueAppearance();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetUnspecifiedValueText)
{
	...
	//wxString _rtn = pThis->GetEntity()->GetUnspecifiedValueText(argFlags);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetVerticalSpacing)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int _rtn = pThis->GetEntity()->GetVerticalSpacing();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __HitTest)
{
	...
	//wxPropertyGridHitTestResult _rtn = pThis->GetEntity()->HitTest(pt);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __IsEditorFocused)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//bool _rtn = pThis->GetEntity()->IsEditorFocused();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __MakeColumnEditable)
{
	...
	//pThis->GetEntity()->MakeColumnEditable(column, editable);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __OnTLPChanging)
{
	...
	//pThis->GetEntity()->OnTLPChanging(newTLP);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __RegisterEditorClass)
{
	...
	//wxPGEditor* _rtn = pThis->GetEntity()->RegisterEditorClass(editor, noDefCheck);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __DoRegisterEditorClass)
{
	...
	//wxPGEditor* _rtn = pThis->GetEntity()->DoRegisterEditorClass(editor, name, noDefCheck);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __ResetColumnSizes)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//bool enableAutoResizing = arg.GetNumber(0)
	//pThis->GetEntity()->ResetColumnSizes(enableAutoResizing);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __RemoveFromSelection)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxPGPropArg id = arg.GetNumber(0)
	//bool _rtn = pThis->GetEntity()->RemoveFromSelection(id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCaptionBackgroundColour)
{
	...
	//pThis->GetEntity()->SetCaptionBackgroundColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCaptionTextColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetCaptionTextColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCellBackgroundColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetCellBackgroundColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCellDisabledTextColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetCellDisabledTextColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCellTextColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetCellTextColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetColumnCount)
{
	...
	//pThis->GetEntity()->SetColumnCount(colCount);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetCurrentCategory)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxPGPropArg id = arg.GetNumber(0)
	//pThis->GetEntity()->SetCurrentCategory(id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetEmptySpaceColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetEmptySpaceColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetLineColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetLineColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetMarginColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetMarginColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSelection)
{
	...
	//pThis->GetEntity()->SetSelection(newSelection);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSelectionBackgroundColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetSelectionBackgroundColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSelectionTextColour)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxColour& col = arg.GetNumber(0)
	//pThis->GetEntity()->SetSelectionTextColour(col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSortFunction)
{
	...
	//pThis->GetEntity()->SetSortFunction(sortFunction);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSplitterPosition)
{
	...
	//pThis->GetEntity()->SetSplitterPosition(newxpos, col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetSplitterLeft)
{
	...
	//pThis->GetEntity()->SetSplitterLeft(privateChildrenToo);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetUnspecifiedValueAppearance)
{
	...
	//pThis->GetEntity()->SetUnspecifiedValueAppearance(cell);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __SetVerticalSpacing)
{
	...
	//pThis->GetEntity()->SetVerticalSpacing(vspacing);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __DoShowPropertyError)
{
	...
	//pThis->GetEntity()->DoShowPropertyError(property, msg);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __DoHidePropertyError)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxPGProperty* property = arg.GetNumber(0)
	//pThis->GetEntity()->DoHidePropertyError(property);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __GetUncommittedPropertyValue)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxVariant _rtn = pThis->GetEntity()->GetUncommittedPropertyValue();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __IsEditorsValueModified)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//bool _rtn = pThis->GetEntity()->IsEditorsValueModified();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __ShowPropertyError)
{
	...
	//wxPGPropArg id = arg.GetNumber(0)
	//const wxString& msg = arg.GetNumber(1)
	//pThis->GetEntity()->ShowPropertyError(id, msg);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_PropertyGrid, __WasValueChangedInEvent)
{
	Object_wx_PropertyGrid *pThis = Object_wx_PropertyGrid::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//bool _rtn = pThis->GetEntity()->WasValueChangedInEvent();
	return Value::Nil;
}
