...
Gura_ImplementMethod(wx_CalendarCtrl, __Create)
{
	...
	//long style = arg.GetNumber(5)
	//const wxString& name = arg.GetNumber(6)
	//pThis->GetEntity()->Create(parent, id, date, pos, size, style, name);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_CalendarCtrl, __HitTest)
{
	...
	//pThis->GetEntity()->HitTest(pos, date, wd);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_CalendarCtrl, __SetDateRange)
{
	...
	//pThis->GetEntity()->SetDateRange(lowerdate, upperdate);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_CalendarCtrl, __GetDateRange)
{
	...
	//pThis->GetEntity()->GetDateRange(lowerdate, upperdate);
	return Value::Nil;
}
