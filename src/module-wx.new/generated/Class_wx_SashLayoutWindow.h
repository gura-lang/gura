...
// wxSashLayoutWindow
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_SASHLAYOUTWINDOW_H__
#define __CLASS_WX_SASHLAYOUTWINDOW_H__
#include <wx/laywin.h>
...
public:
	...
	inline wxSashLayoutWindow *GetEntity() {
		return static_cast<wxSashLayoutWindow *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxSashLayoutWindow");
		return true;
	}
};
