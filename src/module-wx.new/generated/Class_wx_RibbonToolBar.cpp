...
Gura_ImplementMethod(wx_RibbonToolBar, __AddTool)
{
	...
	//pThis->GetEntity()->AddTool(tool_id, bitmap, help_string, kind);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __AddDropdownTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(1)
	//const wxString& help_string = arg.GetNumber(2)
	//pThis->GetEntity()->AddDropdownTool(tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __AddHybridTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(1)
	//const wxString& help_string = arg.GetNumber(2)
	//pThis->GetEntity()->AddHybridTool(tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __AddToggleTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(1)
	//const wxString& help_string = arg.GetNumber(2)
	//pThis->GetEntity()->AddToggleTool(tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __AddTool_1)
{
	...
	//pThis->GetEntity()->AddTool(tool_id, bitmap, bitmap_disabled, help_string, kind, client_data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __InsertTool)
{
	...
	//const wxString& help_string = arg.GetNumber(3)
	//wxRibbonButtonKind kind = arg.GetNumber(4)
	//pThis->GetEntity()->InsertTool(pos, tool_id, bitmap, help_string, kind);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __InsertDropdownTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(2)
	//const wxString& help_string = arg.GetNumber(3)
	//pThis->GetEntity()->InsertDropdownTool(pos, tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __InsertHybridTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(2)
	//const wxString& help_string = arg.GetNumber(3)
	//pThis->GetEntity()->InsertHybridTool(pos, tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __InsertToggleTool)
{
	...
	//const wxBitmap& bitmap = arg.GetNumber(2)
	//const wxString& help_string = arg.GetNumber(3)
	//pThis->GetEntity()->InsertToggleTool(pos, tool_id, bitmap, help_string);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __InsertTool_1)
{
	...
	//pThis->GetEntity()->InsertTool(pos, tool_id, bitmap, bitmap_disabled, help_string, kind, client_data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __FindById)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->FindById(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __GetToolId)
{
	...
	//pThis->GetEntity()->GetToolId(tool);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __GetToolClientData)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolClientData(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __GetToolHelpString)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolHelpString(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __GetToolKind)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolKind(tool_id);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_RibbonToolBar, __GetToolState)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int tool_id = arg.GetNumber(0)
	//pThis->GetEntity()->GetToolState(tool_id);
	return Value::Nil;
}
