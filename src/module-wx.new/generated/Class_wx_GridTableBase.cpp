...
Gura_ImplementMethod(wx_GridTableBase, __SetValueAsLong)
{
	...
	//pThis->GetEntity()->SetValueAsLong(row, col, value);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetValueAsDouble)
{
	...
	//pThis->GetEntity()->SetValueAsDouble(row, col, value);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetValueAsBool)
{
	...
	//pThis->GetEntity()->SetValueAsBool(row, col, value);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetValueAsCustom)
{
	...
	//pThis->GetEntity()->SetValueAsCustom(row, col, typeName, value);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetRowLabelValue)
{
	...
	//pThis->GetEntity()->SetRowLabelValue(row, label);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetColLabelValue)
{
	...
	//int col = arg.GetNumber(0)
	//const wxString& label = arg.GetNumber(1)
	//pThis->GetEntity()->SetColLabelValue(col, label);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridTableBase, __SetAttrProvider)
{
	...
	//pThis->GetEntity()->SetAttrProvider(attrProvider);
	return Value::Nil;
}
