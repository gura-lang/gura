...
Gura_ImplementMethod(wx_SizerFlags, __Align)
{
	...
	//wxSizerFlags& _rtn = pThis->GetEntity()->Align(alignment);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Border)
{
	...
	//wxSizerFlags& _rtn = pThis->GetEntity()->Border(direction, borderinpixels);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Border_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int direction = arg.GetNumber(0)
	//wxSizerFlags& _rtn = pThis->GetEntity()->Border(direction);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Bottom)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Bottom();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Center)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Center();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Centre)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Centre();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __CenterHorizontal)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->CenterHorizontal();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __CenterVertical)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->CenterVertical();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __CentreHorizontal)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->CentreHorizontal();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __CentreVertical)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->CentreVertical();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __DoubleBorder)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int direction = arg.GetNumber(0)
	//wxSizerFlags& _rtn = pThis->GetEntity()->DoubleBorder(direction);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __DoubleHorzBorder)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->DoubleHorzBorder();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Expand)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Expand();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __FixedMinSize)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->FixedMinSize();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __ReserveSpaceEvenIfHidden)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->ReserveSpaceEvenIfHidden();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __GetDefaultBorder)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int _rtn = pThis->GetEntity()->GetDefaultBorder();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Left)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Left();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Proportion)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int proportion = arg.GetNumber(0)
	//wxSizerFlags& _rtn = pThis->GetEntity()->Proportion(proportion);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Right)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Right();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Shaped)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Shaped();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __Top)
{
	Object_wx_SizerFlags *pThis = Object_wx_SizerFlags::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizerFlags& _rtn = pThis->GetEntity()->Top();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_SizerFlags, __TripleBorder)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//int direction = arg.GetNumber(0)
	//wxSizerFlags& _rtn = pThis->GetEntity()->TripleBorder(direction);
	return Value::Nil;
}
