...
Gura_ImplementMethod(wx_TreeListCtrl, __AppendColumn)
{
	...
	//int _rtn = pThis->GetEntity()->AppendColumn(title, width, align, flags);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetColumnCount)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//unsigned _rtn = pThis->GetEntity()->GetColumnCount();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __WidthFor)
{
	...
	//int _rtn = pThis->GetEntity()->WidthFor(text);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __AppendItem)
{
	...
	//wxTreeListItem _rtn = pThis->GetEntity()->AppendItem(parent, text, imageClosed, imageOpened, data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __InsertItem)
{
	...
	//wxTreeListItem _rtn = pThis->GetEntity()->InsertItem(parent, previous, text, imageClosed, imageOpened, data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __PrependItem)
{
	...
	//int imageOpened = arg.GetNumber(3)
	//wxClientData* data = arg.GetNumber(4)
	//wxTreeListItem _rtn = pThis->GetEntity()->PrependItem(parent, text, imageClosed, imageOpened, data);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetRootItem)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem _rtn = pThis->GetEntity()->GetRootItem();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetItemParent)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//wxTreeListItem _rtn = pThis->GetEntity()->GetItemParent(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetFirstChild)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//wxTreeListItem _rtn = pThis->GetEntity()->GetFirstChild(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetNextSibling)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//wxTreeListItem _rtn = pThis->GetEntity()->GetNextSibling(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetFirstItem)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem _rtn = pThis->GetEntity()->GetFirstItem();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetNextItem)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//wxTreeListItem _rtn = pThis->GetEntity()->GetNextItem(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetItemText)
{
	...
	//const wxString& _rtn = pThis->GetEntity()->GetItemText(item, col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __SetItemText)
{
	...
	//unsigned col = arg.GetNumber(1)
	//const wxString& text = arg.GetNumber(2)
	//pThis->GetEntity()->SetItemText(item, col, text);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __SetItemImage)
{
	...
	//pThis->GetEntity()->SetItemImage(item, closed, opened);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetSelection)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem _rtn = pThis->GetEntity()->GetSelection();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetSelections)
{
	...
	//unsigned _rtn = pThis->GetEntity()->GetSelections(selections);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __CheckItem)
{
	...
	//pThis->GetEntity()->CheckItem(item, state);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __CheckItemRecursively)
{
	...
	//wxTreeListItem item = arg.GetNumber(0)
	//wxCheckBoxState state = arg.GetNumber(1)
	//pThis->GetEntity()->CheckItemRecursively(item, state);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __UncheckItem)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//pThis->GetEntity()->UncheckItem(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __UpdateItemParentStateRecursively)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//pThis->GetEntity()->UpdateItemParentStateRecursively(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetCheckedState)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxTreeListItem item = arg.GetNumber(0)
	//wxCheckBoxState _rtn = pThis->GetEntity()->GetCheckedState(item);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __AreAllChildrenInState)
{
	...
	//wxTreeListItem item = arg.GetNumber(0)
	//wxCheckBoxState state = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->AreAllChildrenInState(item, state);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __SetSortColumn)
{
	...
	//pThis->GetEntity()->SetSortColumn(col, ascendingOrder);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetSortColumn)
{
	...
	//unsigned* col = arg.GetNumber(0)
	//bool* ascendingOrder = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->GetSortColumn(col, ascendingOrder);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __SetItemComparator)
{
	...
	//pThis->GetEntity()->SetItemComparator(comparator);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetView)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWindow* _rtn = pThis->GetEntity()->GetView();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_TreeListCtrl, __GetDataView)
{
	Object_wx_TreeListCtrl *pThis = Object_wx_TreeListCtrl::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxDataViewCtrl* _rtn = pThis->GetEntity()->GetDataView();
	return Value::Nil;
}
