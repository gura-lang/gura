...
Gura_ImplementMethod(wx_GridBagSizer, __Add)
{
	...
	//wxSizerItem* _rtn = pThis->GetEntity()->Add(window, pos, span, flag, border, userData);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __Add_1)
{
	...
	//int border = arg.GetNumber(4)
	//wxObject* userData = arg.GetNumber(5)
	//wxSizerItem* _rtn = pThis->GetEntity()->Add(sizer, pos, span, flag, border, userData);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __Add_3)
{
	...
	//wxSizerItem* _rtn = pThis->GetEntity()->Add(width, height, pos, span, flag, border, userData);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __CheckForIntersection)
{
	...
	//bool _rtn = pThis->GetEntity()->CheckForIntersection(item, excludeItem);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __CheckForIntersection_1)
{
	...
	//bool _rtn = pThis->GetEntity()->CheckForIntersection(pos, span, excludeItem);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __FindItem)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWindow* window = arg.GetNumber(0)
	//wxGBSizerItem* _rtn = pThis->GetEntity()->FindItem(window);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __FindItem_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizer* sizer = arg.GetNumber(0)
	//wxGBSizerItem* _rtn = pThis->GetEntity()->FindItem(sizer);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __FindItemAtPoint)
{
	...
	//wxGBSizerItem* _rtn = pThis->GetEntity()->FindItemAtPoint(pt);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __FindItemAtPosition)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxGBPosition& pos = arg.GetNumber(0)
	//wxGBSizerItem* _rtn = pThis->GetEntity()->FindItemAtPosition(pos);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __FindItemWithData)
{
	...
	//wxGBSizerItem* _rtn = pThis->GetEntity()->FindItemWithData(userData);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetCellSize)
{
	...
	//wxSize _rtn = pThis->GetEntity()->GetCellSize(row, col);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetEmptyCellSize)
{
	Object_wx_GridBagSizer *pThis = Object_wx_GridBagSizer::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSize _rtn = pThis->GetEntity()->GetEmptyCellSize();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemPosition)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWindow* window = arg.GetNumber(0)
	//wxGBPosition _rtn = pThis->GetEntity()->GetItemPosition(window);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemPosition_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizer* sizer = arg.GetNumber(0)
	//wxGBPosition _rtn = pThis->GetEntity()->GetItemPosition(sizer);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemPosition_2)
{
	...
	//wxGBPosition _rtn = pThis->GetEntity()->GetItemPosition(index);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemSpan)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWindow* window = arg.GetNumber(0)
	//wxGBSpan _rtn = pThis->GetEntity()->GetItemSpan(window);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemSpan_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxSizer* sizer = arg.GetNumber(0)
	//wxGBSpan _rtn = pThis->GetEntity()->GetItemSpan(sizer);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __GetItemSpan_2)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//size_t index = arg.GetNumber(0)
	//wxGBSpan _rtn = pThis->GetEntity()->GetItemSpan(index);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemPosition)
{
	...
	//wxWindow* window = arg.GetNumber(0)
	//const wxGBPosition& pos = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemPosition(window, pos);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemPosition_1)
{
	...
	//wxSizer* sizer = arg.GetNumber(0)
	//const wxGBPosition& pos = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemPosition(sizer, pos);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemPosition_2)
{
	...
	//size_t index = arg.GetNumber(0)
	//const wxGBPosition& pos = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemPosition(index, pos);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemSpan)
{
	...
	//wxWindow* window = arg.GetNumber(0)
	//const wxGBSpan& span = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemSpan(window, span);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemSpan_1)
{
	...
	//wxSizer* sizer = arg.GetNumber(0)
	//const wxGBSpan& span = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemSpan(sizer, span);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_GridBagSizer, __SetItemSpan_2)
{
	...
	//size_t index = arg.GetNumber(0)
	//const wxGBSpan& span = arg.GetNumber(1)
	//bool _rtn = pThis->GetEntity()->SetItemSpan(index, span);
	return Value::Nil;
}
