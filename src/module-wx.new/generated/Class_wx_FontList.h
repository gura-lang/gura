...
//----------------------------------------------------------------------------
class Object_wx_FontList : public Object {
protected:
	wxFontList *_pEntity;
...
public:
	...
	inline void SetEntity(wxFontList *pEntity, GuraObjectObserver *pObserver, bool ownerFlag) {
	...
	inline wxFontList *GetEntity() {
		return static_cast<wxFontList *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxFontList");
		return true;
	}
};
