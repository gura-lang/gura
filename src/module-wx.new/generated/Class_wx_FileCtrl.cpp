...
Gura_ImplementFunction(__FileCtrl_1)
{
	...
	//wxFileCtrl(parent, id, defaultDirectory, defaultFilename, wildCard, style, pos, size, name);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_FileCtrl, __Create)
{
	...
	//const wxSize& size = arg.GetNumber(7)
	//const wxString& name = arg.GetNumber(8)
	//bool _rtn = pThis->GetEntity()->Create(parent, id, defaultDirectory, defaultFilename, wildCard, style, pos, size, name);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_FileCtrl, __SetDirectory)
{
	...
	//bool _rtn = pThis->GetEntity()->SetDirectory(directory);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_FileCtrl, __SetFilename)
{
	...
	//bool _rtn = pThis->GetEntity()->SetFilename(filename);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_FileCtrl, __SetPath)
{
	...
	//bool _rtn = pThis->GetEntity()->SetPath(path);
	return Value::Nil;
}
