...
// wxAppTraits
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_APPTRAITS_H__
#define __CLASS_WX_APPTRAITS_H__
...
public:
	...
	inline wxAppTraits *GetEntity() {
		return static_cast<wxAppTraits *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxAppTraits");
		return true;
	}
};
