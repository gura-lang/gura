...
//----------------------------------------------------------------------------
Gura_DeclareMethodAlias(wx_PageSetupDialog, __wxPageSetupDialog, "wxPageSetupDialog")
{
...
Gura_ImplementMethod(wx_PageSetupDialog, __wxPageSetupDialog)
{
...
{
	Gura_AssignMethod(wx_PageSetupDialog, __wxPageSetupDialog);
