...
// wxGBPosition
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_GBPOSITION_H__
#define __CLASS_WX_GBPOSITION_H__
...
public:
	...
	inline wxGBPosition *GetEntity() {
		return static_cast<wxGBPosition *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxGBPosition");
		return true;
	}
};
