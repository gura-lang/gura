...
//----------------------------------------------------------------------------
class Object_wx_DDEClient : public Object_wx_Object {
public:
...
public:
	inline Object_wx_DDEClient(wxDDEClient *pEntity, GuraObjectObserver *pObserver, bool ownerFlag) :
				Object_wx_Object(Gura_UserClass(wx_DDEClient), pEntity, pObserver, ownerFlag) {}
	...
	inline wxDDEClient *GetEntity() {
		return static_cast<wxDDEClient *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxDDEClient");
		return true;
	}
};
