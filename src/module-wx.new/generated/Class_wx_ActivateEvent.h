...
// wxActivateEvent
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_ACTIVATEEVENT_H__
#define __CLASS_WX_ACTIVATEEVENT_H__
#include <wx/event.h>
...
public:
	...
	inline wxActivateEvent *GetEntity() {
		return static_cast<wxActivateEvent *>(_pEntity);
	}
	...
	inline bool IsInvalid(Environment &env) const {
		...
		SetError_InvalidWxObject(env, "wxActivateEvent");
		return true;
	}
};
