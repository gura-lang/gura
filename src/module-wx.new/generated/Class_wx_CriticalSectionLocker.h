...
//----------------------------------------------------------------------------
#ifndef __CLASS_WX_CRITICALSECTIONLOCKER_H__
#define __CLASS_WX_CRITICALSECTIONLOCKER_H__
#include <wx/thread.h>
...
public:
	...
	inline wxCriticalSectionLocker *GetEntity() {
		return static_cast<wxCriticalSectionLocker *>(_pEntity);
	}
