...
Gura_ImplementMethod(wx_UString, __FromAscii)
{
	...
	//wxUString _rtn = pThis->GetEntity()->FromAscii(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __FromAscii_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const char* str = arg.GetNumber(0)
	//wxUString _rtn = pThis->GetEntity()->FromAscii(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __FromUTF8)
{
	...
	//const char* str = arg.GetNumber(0)
	//size_t n = arg.GetNumber(1)
	//wxUString _rtn = pThis->GetEntity()->FromUTF8(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __FromUTF8_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const char* str = arg.GetNumber(0)
	//wxUString _rtn = pThis->GetEntity()->FromUTF8(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __FromUTF16)
{
	...
	//const wxChar16* str = arg.GetNumber(0)
	//size_t n = arg.GetNumber(1)
	//wxUString _rtn = pThis->GetEntity()->FromUTF16(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __FromUTF16_1)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxChar16* str = arg.GetNumber(0)
	//wxUString _rtn = pThis->GetEntity()->FromUTF16(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromAscii)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const char* str = arg.GetNumber(0)
	//wxUString& _rtn = pThis->GetEntity()->assignFromAscii(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromAscii_1)
{
	...
	//const char* str = arg.GetNumber(0)
	//size_t n = arg.GetNumber(1)
	//wxUString& _rtn = pThis->GetEntity()->assignFromAscii(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromUTF8)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const char* str = arg.GetNumber(0)
	//wxUString& _rtn = pThis->GetEntity()->assignFromUTF8(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromUTF8_1)
{
	...
	//const char* str = arg.GetNumber(0)
	//size_t n = arg.GetNumber(1)
	//wxUString& _rtn = pThis->GetEntity()->assignFromUTF8(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromUTF16)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxChar16* str = arg.GetNumber(0)
	//wxUString& _rtn = pThis->GetEntity()->assignFromUTF16(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromUTF16_1)
{
	...
	//const wxChar16* str = arg.GetNumber(0)
	//size_t n = arg.GetNumber(1)
	//wxUString& _rtn = pThis->GetEntity()->assignFromUTF16(str, n);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromCString)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const char* str = arg.GetNumber(0)
	//wxUString& _rtn = pThis->GetEntity()->assignFromCString(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assignFromCString_1)
{
	...
	//const char* str = arg.GetNumber(0)
	//const wxMBConv& conv = arg.GetNumber(1)
	//wxUString& _rtn = pThis->GetEntity()->assignFromCString(str, conv);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __utf8_str)
{
	Object_wx_UString *pThis = Object_wx_UString::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxCharBuffer _rtn = pThis->GetEntity()->utf8_str();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __utf16_str)
{
	Object_wx_UString *pThis = Object_wx_UString::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxU16CharBuffer _rtn = pThis->GetEntity()->utf16_str();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __wc_str)
{
	Object_wx_UString *pThis = Object_wx_UString::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//wxWCharBuffer _rtn = pThis->GetEntity()->wc_str();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __wxString)
{
	Object_wx_UString *pThis = Object_wx_UString::GetObjectThis(arg);
	if (pThis->IsInvalid(env)) return Value::Nil;
	//operator _rtn = pThis->GetEntity()->wxString();
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __assign)
{
	...
	if (pThis->IsInvalid(env)) return Value::Nil;
	//const wxUString& str = arg.GetNumber(0)
	//wxUString& _rtn = pThis->GetEntity()->assign(str);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __append)
{
	...
	//wxUString& _rtn = pThis->GetEntity()->append(s);
	return Value::Nil;
}
...
Gura_ImplementMethod(wx_UString, __insert)
{
	...
	//wxUString& _rtn = pThis->GetEntity()->insert(pos, s);
	return Value::Nil;
}
