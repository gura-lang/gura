...
Gura_ImplementFunction(FFileOutputStream)
{
	...
	Object_wx_FFileOutputStream *pObj = Object_wx_FFileOutputStream::GetSelfObj(args);
	if (pObj == NULL) {
...
{
	Object_wx_FFileOutputStream *pSelf = Object_wx_FFileOutputStream::GetSelfObj(args);
