...
String Object_wx_DataViewToggleRenderer::ToString(Signal sig, bool exprFlag)
{
...
void Object_wx_DataViewToggleRenderer::OnModuleEntry(Environment &env, Signal sig)
{
