...
#define AssignConstructor(className) \
Object_wx_##className::DoAssignConstructor(env, sig)
...
Gura_ModuleEntry()
{
	...
	AssignConstructor(EventFactory);
	// Realize classes
...
_MS(PrepareClass(ThreadHelper));
	...
	// Initialize classes
	AssignConstructor(AboutDialogInfo);
	AssignConstructor(LanguageInfo);
	AssignConstructor(MouseState);
	AssignConstructor(AcceleratorEntry);
	AssignConstructor(AppTraits);
	AssignConstructor(AuiDockArt);
	AssignConstructor(AuiTabArt);
	AssignConstructor(AuiPaneInfo);
	AssignConstructor(List);
	AssignConstructor(BusyCursor);
	AssignConstructor(BusyInfo);
	AssignConstructor(CalendarDateAttr);
	AssignConstructor(Caret);
	AssignConstructor(ClassInfo);
	AssignConstructor(ClientData);
	AssignConstructor(TreeItemData);
	AssignConstructor(ClientDataContainer);
	AssignConstructor(CmdLineParser);
	AssignConstructor(ColourDatabase);
	AssignConstructor(ComboPopup);
	AssignConstructor(Condition);
	AssignConstructor(ConfigBase);
	AssignConstructor(FileConfig);
	AssignConstructor(CriticalSection);
	AssignConstructor(CriticalSectionLocker);
	AssignConstructor(DataFormat);
_MS(AssignConstructor(DataInputStream));
	AssignConstructor(DataObject);
_MS(AssignConstructor(DataObjectComposite));
_MS(AssignConstructor(URLDataObject));
	AssignConstructor(DataObjectSimple);
	AssignConstructor(BitmapDataObject);
	AssignConstructor(CustomDataObject);
	AssignConstructor(FileDataObject);
	AssignConstructor(TextDataObject);
_MS(AssignConstructor(DataOutputStream));
	AssignConstructor(DateSpan);
	AssignConstructor(DateTime);
	AssignConstructor(DateTimeHolidayAuthority);
	AssignConstructor(DateTimeWorkDays);
	AssignConstructor(DCClipper);
	AssignConstructor(DebugReport);
	AssignConstructor(DebugReportCompress);
	AssignConstructor(DebugReportUpload);
	AssignConstructor(DebugReportPreview);
	AssignConstructor(DebugReportPreviewStd);
	AssignConstructor(DialUpManager);
	AssignConstructor(Dir);
	AssignConstructor(DirTraverser);
	AssignConstructor(Display);
	AssignConstructor(DropSource);
	AssignConstructor(DropTarget);
	AssignConstructor(FileDropTarget);
	AssignConstructor(TextDropTarget);
	AssignConstructor(DynamicLibrary);
	AssignConstructor(DynamicLibraryDetails);
	AssignConstructor(FFile);
	AssignConstructor(File);
	AssignConstructor(FileName);
	AssignConstructor(FileType);
	AssignConstructor(FontEnumerator);
	AssignConstructor(FontMapper);
	AssignConstructor(GBPosition);
	AssignConstructor(GBSpan);
	AssignConstructor(GridCellAttr);
	AssignConstructor(GridCellWorker);
	AssignConstructor(GridCellEditor);
	AssignConstructor(GridCellBoolEditor);
	AssignConstructor(GridCellChoiceEditor);
	AssignConstructor(GridCellTextEditor);
	AssignConstructor(GridCellFloatEditor);
	AssignConstructor(GridCellNumberEditor);
	AssignConstructor(GridCellAutoWrapStringEditor);
	AssignConstructor(GridCellRenderer);
	AssignConstructor(GridCellBoolRenderer);
	AssignConstructor(GridCellStringRenderer);
	AssignConstructor(GridCellFloatRenderer);
	AssignConstructor(GridCellNumberRenderer);
	AssignConstructor(GridCellAutoWrapStringRenderer);
	AssignConstructor(HelpProvider);
	AssignConstructor(SimpleHelpProvider);
	AssignConstructor(HelpControllerHelpProvider);
	AssignConstructor(HtmlModalHelp);
	AssignConstructor(IconBundle);
	AssignConstructor(IconLocation);
	AssignConstructor(ListItemAttr);
	AssignConstructor(Locale);
	AssignConstructor(Log);
	AssignConstructor(LogChain);
	AssignConstructor(LogPassThrough);
	AssignConstructor(LogWindow);
	AssignConstructor(LogGui);
	AssignConstructor(LogStderr);
	AssignConstructor(LogTextCtrl);
	AssignConstructor(LongLong);
	AssignConstructor(MBConv);
	AssignConstructor(CSConv);
	AssignConstructor(MBConvUTF7);
	AssignConstructor(MBConvUTF8);
	AssignConstructor(MBConvUTF16);
	AssignConstructor(MBConvUTF32);
	AssignConstructor(MemoryBuffer);
	AssignConstructor(MimeTypesManager);
	AssignConstructor(Mutex);
	AssignConstructor(MutexLocker);
	AssignConstructor(Node);
	AssignConstructor(Object);
	AssignConstructor(ConnectionBase);
	AssignConstructor(Connection);
_MS(AssignConstructor(DDEConnection));
	AssignConstructor(TCPConnection);
	AssignConstructor(HelpControllerBase);
	AssignConstructor(HelpController);
	AssignConstructor(HtmlHelpController);
	AssignConstructor(ServerBase);
_MS(AssignConstructor(DDEServer));
	AssignConstructor(Server);
	AssignConstructor(TCPServer);
	AssignConstructor(ClientBase);
	AssignConstructor(Client);
_MS(AssignConstructor(DDEClient));
	AssignConstructor(TCPClient);
	AssignConstructor(AcceleratorTable);
	AssignConstructor(ArchiveClassFactory);
	AssignConstructor(TarClassFactory);
	AssignConstructor(ZipClassFactory);
	AssignConstructor(ArchiveEntry);
	AssignConstructor(TarEntry);
	AssignConstructor(ZipEntry);
	AssignConstructor(ArtProvider);
_MS(AssignConstructor(AutomationObject));
	AssignConstructor(BitmapHandler);
	AssignConstructor(Clipboard);
	AssignConstructor(Colour);
	AssignConstructor(ColourData);
	AssignConstructor(Command);
	AssignConstructor(CommandProcessor);
	AssignConstructor(ContextHelp);
_MS(AssignConstructor(DataViewColumn));
_MS(AssignConstructor(DataViewListModelNotifier));
_MS(AssignConstructor(DataViewModel));
_MS(AssignConstructor(DataViewListModel));
_MS(AssignConstructor(DataViewSortedListModel));
_MS(AssignConstructor(DataViewRenderer));
_MS(AssignConstructor(DataViewTextRenderer));
_MS(AssignConstructor(DataViewProgressRenderer));
_MS(AssignConstructor(DataViewToggleRenderer));
_MS(AssignConstructor(DataViewBitmapRenderer));
_MS(AssignConstructor(DataViewDateRenderer));
_MS(AssignConstructor(DataViewCustomRenderer));
	AssignConstructor(DC);
	AssignConstructor(MemoryDC);
	AssignConstructor(BufferedDC);
	AssignConstructor(BufferedPaintDC);
	AssignConstructor(AutoBufferedPaintDC);
_MS(AssignConstructor(MetafileDC));
	AssignConstructor(MirrorDC);
_MS(AssignConstructor(PrinterDC));
	AssignConstructor(ScreenDC);
	AssignConstructor(WindowDC);
	AssignConstructor(ClientDC);
	AssignConstructor(PaintDC);
	AssignConstructor(DocTemplate);
	AssignConstructor(DragImage);
	AssignConstructor(EncodingConverter);
	AssignConstructor(Event);
	AssignConstructor(ActivateEvent);
	AssignConstructor(CalculateLayoutEvent);
	AssignConstructor(CloseEvent);
	AssignConstructor(CommandEvent);
_MS(AssignConstructor(ActiveXEvent));
	AssignConstructor(ClipboardTextEvent);
	AssignConstructor(CollapsiblePaneEvent);
	AssignConstructor(ColourPickerEvent);
	AssignConstructor(ChildFocusEvent);
	AssignConstructor(ContextMenuEvent);
	AssignConstructor(DateEvent);
	AssignConstructor(CalendarEvent);
	AssignConstructor(FileDirPickerEvent);
	AssignConstructor(FindDialogEvent);
	AssignConstructor(FontPickerEvent);
	AssignConstructor(HelpEvent);
	AssignConstructor(HtmlLinkEvent);
	AssignConstructor(HtmlCellEvent);
	AssignConstructor(HyperlinkEvent);
	AssignConstructor(NotifyEvent);
	AssignConstructor(BookCtrlBaseEvent);
	AssignConstructor(TreebookEvent);
_MS(AssignConstructor(DataViewEvent));
	AssignConstructor(GridEvent);
	AssignConstructor(GridRangeSelectEvent);
	AssignConstructor(GridSizeEvent);
	AssignConstructor(ListEvent);
_MS(AssignConstructor(MediaEvent));
	AssignConstructor(NotebookEvent);
	AssignConstructor(ListbookEvent);
	AssignConstructor(ChoicebookEvent);
	AssignConstructor(ToolbookEvent);
	AssignConstructor(RichTextEvent);
	AssignConstructor(SpinEvent);
	AssignConstructor(SplitterEvent);
	AssignConstructor(TreeEvent);
	AssignConstructor(WizardEvent);
	AssignConstructor(SashEvent);
	AssignConstructor(ScrollEvent);
	AssignConstructor(UpdateUIEvent);
	AssignConstructor(WindowCreateEvent);
	AssignConstructor(WindowDestroyEvent);
	AssignConstructor(DialUpEvent);
	AssignConstructor(DropFilesEvent);
	AssignConstructor(EraseEvent);
	AssignConstructor(FocusEvent);
	AssignConstructor(GridEditorCreatedEvent);
	AssignConstructor(IconizeEvent);
	AssignConstructor(IdleEvent);
	AssignConstructor(InitDialogEvent);
	AssignConstructor(JoystickEvent);
	AssignConstructor(KeyEvent);
	AssignConstructor(MaximizeEvent);
	AssignConstructor(MenuEvent);
	AssignConstructor(MouseCaptureChangedEvent);
	AssignConstructor(MouseCaptureLostEvent);
	AssignConstructor(MouseEvent);
	AssignConstructor(MoveEvent);
	AssignConstructor(PaintEvent);
_MS(AssignConstructor(PowerEvent));
	AssignConstructor(ProcessEvent);
	AssignConstructor(QueryLayoutInfoEvent);
	AssignConstructor(ScrollWinEvent);
	AssignConstructor(SetCursorEvent);
	AssignConstructor(SizeEvent);
	AssignConstructor(SocketEvent);
	AssignConstructor(SysColourChangedEvent);
	AssignConstructor(TimerEvent);
	AssignConstructor(EvtHandler);
	AssignConstructor(App);
	AssignConstructor(AuiManager);
	AssignConstructor(DocManager);
	AssignConstructor(Document);
	AssignConstructor(Menu);
	AssignConstructor(Process);
	AssignConstructor(TaskBarIcon);
	AssignConstructor(Timer);
	AssignConstructor(Validator);
	AssignConstructor(GenericValidator);
	AssignConstructor(TextValidator);
	AssignConstructor(View);
	AssignConstructor(Window);
	AssignConstructor(PopupWindow);
	AssignConstructor(PopupTransientWindow);
	AssignConstructor(TipWindow);
_MS(AssignConstructor(ActiveXContainer));
	AssignConstructor(Control);
	AssignConstructor(TextCtrlBase);
	AssignConstructor(RichTextCtrl);
	AssignConstructor(BookCtrlBase);
	AssignConstructor(Choicebook);
	AssignConstructor(Toolbook);
	AssignConstructor(Treebook);
	AssignConstructor(ToolBarBase);
	AssignConstructor(ToolBar);
	AssignConstructor(AnimationCtrl);
	AssignConstructor(AuiNotebook);
	AssignConstructor(Button);
	AssignConstructor(BitmapButton);
	AssignConstructor(ContextHelpButton);
	AssignConstructor(CalendarCtrl);
	AssignConstructor(CheckBox);
	AssignConstructor(CollapsiblePane);
	AssignConstructor(ComboCtrl);
	AssignConstructor(OwnerDrawnComboBox);
	AssignConstructor(BitmapComboBox);
	AssignConstructor(RichTextStyleComboCtrl);
	AssignConstructor(ControlWithItems);
	AssignConstructor(Choice);
	AssignConstructor(ComboBox);
	AssignConstructor(ListBox);
	AssignConstructor(CheckListBox);
_MS(AssignConstructor(DataViewCtrl));
	AssignConstructor(DatePickerCtrl);
	AssignConstructor(Gauge);
	AssignConstructor(GenericDirCtrl);
	AssignConstructor(HyperlinkCtrl);
	AssignConstructor(Listbook);
	AssignConstructor(ListCtrl);
	AssignConstructor(ListView);
_MS(AssignConstructor(MediaCtrl));
	AssignConstructor(Notebook);
	AssignConstructor(PickerBase);
	AssignConstructor(ColourPickerCtrl);
	AssignConstructor(DirPickerCtrl);
	AssignConstructor(FilePickerCtrl);
	AssignConstructor(FontPickerCtrl);
	AssignConstructor(RadioBox);
	AssignConstructor(RadioButton);
	AssignConstructor(RichTextStyleListCtrl);
	AssignConstructor(ScrollBar);
	AssignConstructor(Slider);
	AssignConstructor(SpinButton);
	AssignConstructor(SpinCtrl);
	AssignConstructor(StaticBitmap);
	AssignConstructor(StaticBox);
	AssignConstructor(StaticLine);
	AssignConstructor(StaticText);
	AssignConstructor(TextCtrl);
	AssignConstructor(ToggleButton);
	AssignConstructor(TreeCtrl);
	AssignConstructor(GLCanvas);
	AssignConstructor(HtmlHelpDialog);
	AssignConstructor(HtmlHelpWindow);
	AssignConstructor(MDIClientWindow);
	AssignConstructor(MenuBar);
	AssignConstructor(Panel);
	AssignConstructor(PreviewControlBar);
	AssignConstructor(ScrolledWindow);
	AssignConstructor(Grid);
	AssignConstructor(HtmlWindow);
	AssignConstructor(PreviewCanvas);
	AssignConstructor(VScrolledWindow);
	AssignConstructor(VListBox);
	AssignConstructor(HtmlListBox);
	AssignConstructor(SimpleHtmlListBox);
	AssignConstructor(RichTextStyleListBox);
	AssignConstructor(WizardPage);
	AssignConstructor(WizardPageSimple);
	AssignConstructor(SashWindow);
	AssignConstructor(SashLayoutWindow);
	AssignConstructor(SearchCtrl);
	AssignConstructor(SplitterWindow);
	AssignConstructor(StatusBar);
	AssignConstructor(TopLevelWindow);
	AssignConstructor(Dialog);
	AssignConstructor(ColourDialog);
	AssignConstructor(DirDialog);
	AssignConstructor(FileDialog);
	AssignConstructor(FindReplaceDialog);
	AssignConstructor(FontDialog);
	AssignConstructor(MessageDialog);
	AssignConstructor(MultiChoiceDialog);
	AssignConstructor(ProgressDialog);
	AssignConstructor(PropertySheetDialog);
	AssignConstructor(RichTextFormattingDialog);
	AssignConstructor(RichTextStyleOrganiserDialog);
	AssignConstructor(SingleChoiceDialog);
	AssignConstructor(SymbolPickerDialog);
	AssignConstructor(TextEntryDialog);
	AssignConstructor(PasswordEntryDialog);
	AssignConstructor(Wizard);
	AssignConstructor(Frame);
	AssignConstructor(DocChildFrame);
	AssignConstructor(DocParentFrame);
	AssignConstructor(HtmlHelpFrame);
	AssignConstructor(MDIChildFrame);
	AssignConstructor(DocMDIChildFrame);
	AssignConstructor(MDIParentFrame);
	AssignConstructor(DocMDIParentFrame);
	AssignConstructor(MiniFrame);
	AssignConstructor(PreviewFrame);
	AssignConstructor(SplashScreen);
	AssignConstructor(FileHistory);
	AssignConstructor(FileSystem);
	AssignConstructor(FileSystemHandler);
	AssignConstructor(MemoryFSHandler);
	AssignConstructor(FilterClassFactory);
	AssignConstructor(FindReplaceData);
	AssignConstructor(FontData);
	AssignConstructor(FSFile);
	AssignConstructor(GDIObject);
	AssignConstructor(Animation);
	AssignConstructor(Bitmap);
	AssignConstructor(Brush);
	AssignConstructor(Cursor);
	AssignConstructor(Font);
	AssignConstructor(Icon);
	AssignConstructor(Palette);
	AssignConstructor(Pen);
	AssignConstructor(Region);
	AssignConstructor(GLContext);
	AssignConstructor(GridTableBase);
	AssignConstructor(HashTable);
	AssignConstructor(HtmlCell);
	AssignConstructor(HtmlColourCell);
	AssignConstructor(HtmlContainerCell);
	AssignConstructor(HtmlWidgetCell);
	AssignConstructor(HtmlDCRenderer);
	AssignConstructor(HtmlEasyPrinting);
	AssignConstructor(HtmlFilter);
	AssignConstructor(HtmlHelpData);
	AssignConstructor(HtmlLinkInfo);
	AssignConstructor(HtmlParser);
	AssignConstructor(HtmlWinParser);
	AssignConstructor(HtmlTag);
	AssignConstructor(HtmlTagHandler);
	AssignConstructor(HtmlWinTagHandler);
	AssignConstructor(Image);
	AssignConstructor(ImageHandler);
	AssignConstructor(ImageList);
	AssignConstructor(IndividualLayoutConstraint);
	AssignConstructor(Joystick);
	AssignConstructor(LayoutAlgorithm);
	AssignConstructor(LayoutConstraints);
	AssignConstructor(ListItem);
	AssignConstructor(Mask);
	AssignConstructor(MenuItem);
_MS(AssignConstructor(Metafile));
	AssignConstructor(Module);
	AssignConstructor(HtmlTagsModule);
	AssignConstructor(PageSetupDialog);
	AssignConstructor(PageSetupDialogData);
	AssignConstructor(PrintData);
	AssignConstructor(PrintDialog);
	AssignConstructor(PrintDialogData);
	AssignConstructor(Printer);
	AssignConstructor(Printout);
	AssignConstructor(HtmlPrintout);
	AssignConstructor(RichTextPrintout);
	AssignConstructor(PrintPreview);
	AssignConstructor(Quantize);
	AssignConstructor(RegionIterator);
	AssignConstructor(RichTextFileHandler);
	AssignConstructor(RichTextHTMLHandler);
	AssignConstructor(RichTextXMLHandler);
	AssignConstructor(RichTextFormattingDialogFactory);
	AssignConstructor(RichTextHeaderFooterData);
	AssignConstructor(RichTextPrinting);
	AssignConstructor(RichTextStyleDefinition);
	AssignConstructor(RichTextCharacterStyleDefinition);
	AssignConstructor(RichTextParagraphStyleDefinition);
	AssignConstructor(RichTextListStyleDefinition);
	AssignConstructor(RichTextStyleSheet);
	AssignConstructor(Sizer);
	AssignConstructor(BoxSizer);
	AssignConstructor(StaticBoxSizer);
	AssignConstructor(StdDialogButtonSizer);
	AssignConstructor(GridSizer);
	AssignConstructor(FlexGridSizer);
	AssignConstructor(GridBagSizer);
	AssignConstructor(SizerItem);
	AssignConstructor(GBSizerItem);
	AssignConstructor(SockAddress);
	AssignConstructor(IPaddress);
	AssignConstructor(IPV4address);
	AssignConstructor(SocketBase);
	AssignConstructor(DatagramSocket);
	AssignConstructor(SocketClient);
	AssignConstructor(Protocol);
	AssignConstructor(FTP);
	AssignConstructor(HTTP);
	AssignConstructor(SocketServer);
	AssignConstructor(Sound);
	AssignConstructor(StringTokenizer);
	AssignConstructor(SystemOptions);
	AssignConstructor(ToolTip);
	AssignConstructor(URI);
	AssignConstructor(URL);
	AssignConstructor(Variant);
	AssignConstructor(VariantData);
	AssignConstructor(XmlDocument);
	AssignConstructor(XmlResource);
	AssignConstructor(XmlResourceHandler);
	AssignConstructor(ObjectRefData);
	AssignConstructor(PenList);
	AssignConstructor(PlatformInfo);
	AssignConstructor(Point);
	AssignConstructor(RealPoint);
	AssignConstructor(Rect);
	AssignConstructor(RecursionGuard);
	AssignConstructor(RegEx);
_MS(AssignConstructor(RegKey));
	AssignConstructor(RendererNative);
	AssignConstructor(DelegateRendererNative);
	AssignConstructor(RendererVersion);
	AssignConstructor(RichTextAttr);
	AssignConstructor(RichTextParagraphLayoutBox);
	AssignConstructor(RichTextBuffer);
	AssignConstructor(RichTextRange);
	AssignConstructor(Semaphore);
	AssignConstructor(SingleInstanceChecker);
	AssignConstructor(Size);
	AssignConstructor(SizerFlags);
	AssignConstructor(SplitterRenderParams);
	AssignConstructor(StackFrame);
	AssignConstructor(StackWalker);
	AssignConstructor(StandardPaths);
	AssignConstructor(StopWatch);
	AssignConstructor(StreamBase);
	AssignConstructor(InputStream);
	AssignConstructor(FFileInputStream);
	AssignConstructor(FileInputStream);
	AssignConstructor(FilterInputStream);
	AssignConstructor(ArchiveInputStream);
	AssignConstructor(TarInputStream);
	AssignConstructor(ZipInputStream);
	AssignConstructor(BufferedInputStream);
	AssignConstructor(ZlibInputStream);
	AssignConstructor(MemoryInputStream);
	AssignConstructor(SocketInputStream);
	AssignConstructor(StringInputStream);
	AssignConstructor(OutputStream);
	AssignConstructor(CountingOutputStream);
	AssignConstructor(FFileOutputStream);
	AssignConstructor(FFileStream);
	AssignConstructor(FileOutputStream);
	AssignConstructor(FileStream);
	AssignConstructor(FilterOutputStream);
	AssignConstructor(ArchiveOutputStream);
	AssignConstructor(TarOutputStream);
	AssignConstructor(ZipOutputStream);
	AssignConstructor(BufferedOutputStream);
	AssignConstructor(ZlibOutputStream);
	AssignConstructor(MemoryOutputStream);
	AssignConstructor(SocketOutputStream);
	AssignConstructor(StringOutputStream);
	AssignConstructor(TempFileOutputStream);
	AssignConstructor(StreamBuffer);
	AssignConstructor(String);
	AssignConstructor(StringBuffer);
	AssignConstructor(StringBufferLength);
	AssignConstructor(SystemSettings);
	AssignConstructor(TempFile);
	AssignConstructor(TextAttr);
	AssignConstructor(TextAttrEx);
	AssignConstructor(TextFile);
	AssignConstructor(TextInputStream);
	AssignConstructor(TextOutputStream);
_MS(AssignConstructor(Thread));
_MS(AssignConstructor(ThreadHelper));
	AssignConstructor(TimeSpan);
	AssignConstructor(TipProvider);
	AssignConstructor(TreeItemId);
	AssignConstructor(WindowUpdateLocker);
	AssignConstructor(WindowDisabler);
	AssignConstructor(XmlNode);
	AssignConstructor(XmlProperty);
	AssignConstructor(ZipNotifier);
	AssignConstructor(NativeEncodingInfo);
	AssignConstructor(NativeFontInfo);
	AssignConstructor(FileTypeInfo);
	AssignConstructor(ArchiveNotifier);
	AssignConstructor(ArtClient);
	AssignConstructor(BMPHandler);
	AssignConstructor(GIFHandler);
	AssignConstructor(JPEGHandler);
	AssignConstructor(PCXHandler);
	AssignConstructor(PNGHandler);
	AssignConstructor(PNMHandler);
	AssignConstructor(TGAHandler);
	AssignConstructor(TIFFHandler);
	AssignConstructor(XPMHandler);
	AssignConstructor(AppConsole);
	AssignConstructor(GridCellCoords);
	AssignConstructor(GridCellAttrProvider);
	AssignConstructor(PageSetupData);
	AssignConstructor(ToolBarToolBase);
	AssignConstructor(HtmlWindowInterface);
	AssignConstructor(HtmlTagsCache);
	AssignConstructor(HtmlEntitiesParser);
	AssignConstructor(RichTextObject);
	AssignConstructor(RichTextImageBlock);
	AssignConstructor(RichTextRenderer);
	AssignConstructor(RichTextAction);
...
{
	::wxLogError(wxString::FromUTF8(sig.GetErrString(true).c_str()));
}
