...
Gura_UserClass(wx_##className)->Prepare()

#define InitializeClass(className) \
Object_wx_##className::OnModuleEntry(env, sig)
...
Gura_ModuleEntry()
{
	...
	// Initialize classes
	InitializeClass(AboutDialogInfo);
	InitializeClass(LanguageInfo);
	InitializeClass(MouseState);
	InitializeClass(AcceleratorEntry);
	InitializeClass(AppTraits);
	InitializeClass(AuiDockArt);
	InitializeClass(AuiTabArt);
	InitializeClass(AuiPaneInfo);
	InitializeClass(List);
	InitializeClass(BusyCursor);
	InitializeClass(BusyInfo);
	InitializeClass(CalendarDateAttr);
	InitializeClass(Caret);
	InitializeClass(ClassInfo);
	InitializeClass(ClientData);
	InitializeClass(TreeItemData);
	InitializeClass(ClientDataContainer);
	InitializeClass(CmdLineParser);
	InitializeClass(ColourDatabase);
	InitializeClass(ComboPopup);
	InitializeClass(Condition);
	InitializeClass(ConfigBase);
	...
	InitializeClass(DateTimeWorkDays);
	InitializeClass(DCClipper);
	InitializeClass(DebugReport);
	InitializeClass(DebugReportCompress);
	InitializeClass(DebugReportUpload);
	InitializeClass(DebugReportPreview);
	InitializeClass(DebugReportPreviewStd);
	InitializeClass(DialUpManager);
	InitializeClass(Dir);
	InitializeClass(DirTraverser);
	InitializeClass(Display);
	InitializeClass(DropSource);
	InitializeClass(DropTarget);
	InitializeClass(FileDropTarget);
	InitializeClass(TextDropTarget);
	InitializeClass(DynamicLibrary);
	InitializeClass(DynamicLibraryDetails);
	InitializeClass(FFile);
	InitializeClass(File);
	InitializeClass(FileName);
	InitializeClass(FileType);
	InitializeClass(FontEnumerator);
	InitializeClass(FontMapper);
	InitializeClass(GBPosition);
	InitializeClass(GBSpan);
	InitializeClass(GridCellAttr);
	InitializeClass(GridCellWorker);
	InitializeClass(GridCellEditor);
	InitializeClass(GridCellBoolEditor);
	InitializeClass(GridCellChoiceEditor);
	InitializeClass(GridCellTextEditor);
	InitializeClass(GridCellFloatEditor);
	InitializeClass(GridCellNumberEditor);
	InitializeClass(GridCellAutoWrapStringEditor);
	InitializeClass(GridCellRenderer);
	InitializeClass(GridCellBoolRenderer);
	InitializeClass(GridCellStringRenderer);
	InitializeClass(GridCellFloatRenderer);
	InitializeClass(GridCellNumberRenderer);
	InitializeClass(GridCellAutoWrapStringRenderer);
	InitializeClass(HelpProvider);
	InitializeClass(SimpleHelpProvider);
	InitializeClass(HelpControllerHelpProvider);
	InitializeClass(HtmlModalHelp);
	InitializeClass(IconBundle);
	InitializeClass(IconLocation);
	InitializeClass(ListItemAttr);
	InitializeClass(Locale);
	InitializeClass(Log);
	InitializeClass(LogChain);
	InitializeClass(LogPassThrough);
	InitializeClass(LogWindow);
	InitializeClass(LogGui);
	InitializeClass(LogStderr);
	InitializeClass(LogTextCtrl);
	InitializeClass(LongLong);
	InitializeClass(MBConv);
	InitializeClass(CSConv);
	InitializeClass(MBConvUTF7);
	InitializeClass(MBConvUTF8);
	InitializeClass(MBConvUTF16);
	InitializeClass(MBConvUTF32);
	InitializeClass(MemoryBuffer);
	InitializeClass(MimeTypesManager);
	InitializeClass(Mutex);
	InitializeClass(MutexLocker);
	...
	InitializeClass(TarClassFactory);
	InitializeClass(ZipClassFactory);
	InitializeClass(ArchiveEntry);
	...
	InitializeClass(PaintDC);
	InitializeClass(DocTemplate);
	InitializeClass(DragImage);
	InitializeClass(EncodingConverter);
	InitializeClass(Event);
	InitializeClass(ActivateEvent);
	...
	InitializeClass(ChildFocusEvent);
	InitializeClass(ContextMenuEvent);
	InitializeClass(DateEvent);
	InitializeClass(CalendarEvent);
	InitializeClass(FileDirPickerEvent);
	InitializeClass(FindDialogEvent);
	InitializeClass(FontPickerEvent);
	InitializeClass(HelpEvent);
	InitializeClass(HtmlLinkEvent);
	InitializeClass(HtmlCellEvent);
	InitializeClass(HyperlinkEvent);
	...
	InitializeClass(ToolbookEvent);
	InitializeClass(RichTextEvent);
	InitializeClass(SpinEvent);
	InitializeClass(SplitterEvent);
	InitializeClass(TreeEvent);
	InitializeClass(WizardEvent);
	InitializeClass(SashEvent);
	InitializeClass(ScrollEvent);
	InitializeClass(UpdateUIEvent);
	InitializeClass(WindowCreateEvent);
	InitializeClass(WindowDestroyEvent);
	InitializeClass(DialUpEvent);
	InitializeClass(DropFilesEvent);
	InitializeClass(EraseEvent);
	InitializeClass(FocusEvent);
	InitializeClass(GridEditorCreatedEvent);
	InitializeClass(IconizeEvent);
	InitializeClass(IdleEvent);
	InitializeClass(InitDialogEvent);
	InitializeClass(JoystickEvent);
	InitializeClass(KeyEvent);
	InitializeClass(MaximizeEvent);
	InitializeClass(MenuEvent);
	InitializeClass(MouseCaptureChangedEvent);
	InitializeClass(MouseCaptureLostEvent);
	...
	InitializeClass(SetCursorEvent);
	InitializeClass(SizeEvent);
	InitializeClass(SocketEvent);
	InitializeClass(SysColourChangedEvent);
	InitializeClass(TimerEvent);
	InitializeClass(EvtHandler);
	InitializeClass(App);
	InitializeClass(AuiManager);
	InitializeClass(DocManager);
	InitializeClass(Document);
	InitializeClass(Menu);
	InitializeClass(Process);
	InitializeClass(TaskBarIcon);
	InitializeClass(Timer);
	InitializeClass(Validator);
	InitializeClass(GenericValidator);
	InitializeClass(TextValidator);
	InitializeClass(View);
	InitializeClass(Window);
	...
	InitializeClass(BookCtrlBase);
	InitializeClass(Choicebook);
	InitializeClass(Toolbook);
	InitializeClass(Treebook);
	InitializeClass(ToolBarBase);
	InitializeClass(ToolBar);
	InitializeClass(AnimationCtrl);
	InitializeClass(AuiNotebook);
	InitializeClass(Button);
	InitializeClass(BitmapButton);
	InitializeClass(ContextHelpButton);
	InitializeClass(CalendarCtrl);
	InitializeClass(CheckBox);
	InitializeClass(CollapsiblePane);
	InitializeClass(ComboCtrl);
	InitializeClass(OwnerDrawnComboBox);
	InitializeClass(BitmapComboBox);
	InitializeClass(RichTextStyleComboCtrl);
	InitializeClass(ControlWithItems);
	InitializeClass(Choice);
	...
	InitializeClass(DirPickerCtrl);
	InitializeClass(FilePickerCtrl);
	InitializeClass(FontPickerCtrl);
	InitializeClass(RadioBox);
	InitializeClass(RadioButton);
	InitializeClass(RichTextStyleListCtrl);
	InitializeClass(ScrollBar);
	InitializeClass(Slider);
	InitializeClass(SpinButton);
	InitializeClass(SpinCtrl);
	InitializeClass(StaticBitmap);
	InitializeClass(StaticBox);
	InitializeClass(StaticLine);
	InitializeClass(StaticText);
	InitializeClass(TextCtrl);
	InitializeClass(ToggleButton);
	InitializeClass(TreeCtrl);
	InitializeClass(GLCanvas);
	InitializeClass(HtmlHelpDialog);
	InitializeClass(HtmlHelpWindow);
	InitializeClass(MDIClientWindow);
	InitializeClass(MenuBar);
	InitializeClass(Panel);
	InitializeClass(PreviewControlBar);
	InitializeClass(ScrolledWindow);
	InitializeClass(Grid);
	InitializeClass(HtmlWindow);
	InitializeClass(PreviewCanvas);
	InitializeClass(VScrolledWindow);
	InitializeClass(VListBox);
	InitializeClass(HtmlListBox);
	InitializeClass(SimpleHtmlListBox);
	InitializeClass(RichTextStyleListBox);
	InitializeClass(WizardPage);
	InitializeClass(WizardPageSimple);
	InitializeClass(SashWindow);
	InitializeClass(SashLayoutWindow);
	InitializeClass(SearchCtrl);
	InitializeClass(SplitterWindow);
	InitializeClass(StatusBar);
	InitializeClass(TopLevelWindow);
	InitializeClass(Dialog);
	InitializeClass(ColourDialog);
	InitializeClass(DirDialog);
	InitializeClass(FileDialog);
	InitializeClass(FindReplaceDialog);
	InitializeClass(FontDialog);
	InitializeClass(MessageDialog);
	InitializeClass(MultiChoiceDialog);
	InitializeClass(ProgressDialog);
	InitializeClass(PropertySheetDialog);
	InitializeClass(RichTextFormattingDialog);
	InitializeClass(RichTextStyleOrganiserDialog);
	InitializeClass(SingleChoiceDialog);
	InitializeClass(SymbolPickerDialog);
	InitializeClass(TextEntryDialog);
	InitializeClass(PasswordEntryDialog);
	InitializeClass(Wizard);
	InitializeClass(Frame);
	InitializeClass(DocChildFrame);
	InitializeClass(DocParentFrame);
	InitializeClass(HtmlHelpFrame);
	InitializeClass(MDIChildFrame);
	InitializeClass(DocMDIChildFrame);
	InitializeClass(MDIParentFrame);
	InitializeClass(DocMDIParentFrame);
	InitializeClass(MiniFrame);
	InitializeClass(PreviewFrame);
	InitializeClass(SplashScreen);
	InitializeClass(FileHistory);
	InitializeClass(FileSystem);
	InitializeClass(FileSystemHandler);
	InitializeClass(MemoryFSHandler);
	InitializeClass(FilterClassFactory);
	InitializeClass(FindReplaceData);
	InitializeClass(FontData);
	InitializeClass(FSFile);
	InitializeClass(GDIObject);
	InitializeClass(Animation);
	InitializeClass(Bitmap);
	InitializeClass(Brush);
	InitializeClass(Cursor);
	InitializeClass(Font);
	InitializeClass(Icon);
	InitializeClass(Palette);
	InitializeClass(Pen);
	InitializeClass(Region);
	InitializeClass(GLContext);
	InitializeClass(GridTableBase);
	InitializeClass(HashTable);
	InitializeClass(HtmlCell);
	InitializeClass(HtmlColourCell);
	InitializeClass(HtmlContainerCell);
	InitializeClass(HtmlWidgetCell);
	InitializeClass(HtmlDCRenderer);
	InitializeClass(HtmlEasyPrinting);
	InitializeClass(HtmlFilter);
	InitializeClass(HtmlHelpData);
	InitializeClass(HtmlLinkInfo);
	InitializeClass(HtmlParser);
	InitializeClass(HtmlWinParser);
	InitializeClass(HtmlTag);
	InitializeClass(HtmlTagHandler);
	InitializeClass(HtmlWinTagHandler);
	InitializeClass(Image);
	InitializeClass(ImageHandler);
	InitializeClass(ImageList);
	InitializeClass(IndividualLayoutConstraint);
	InitializeClass(Joystick);
	InitializeClass(LayoutAlgorithm);
	InitializeClass(LayoutConstraints);
	...
	InitializeClass(PageSetupDialogData);
	InitializeClass(PrintData);
	InitializeClass(PrintDialog);
	InitializeClass(PrintDialogData);
	InitializeClass(Printer);
	InitializeClass(Printout);
	InitializeClass(HtmlPrintout);
	InitializeClass(RichTextPrintout);
	InitializeClass(PrintPreview);
	InitializeClass(Quantize);
	InitializeClass(RegionIterator);
	InitializeClass(RichTextFileHandler);
	InitializeClass(RichTextHTMLHandler);
	InitializeClass(RichTextXMLHandler);
	InitializeClass(RichTextFormattingDialogFactory);
	InitializeClass(RichTextHeaderFooterData);
	InitializeClass(RichTextPrinting);
	InitializeClass(RichTextStyleDefinition);
	InitializeClass(RichTextCharacterStyleDefinition);
	InitializeClass(RichTextParagraphStyleDefinition);
	InitializeClass(RichTextListStyleDefinition);
	InitializeClass(RichTextStyleSheet);
	InitializeClass(Sizer);
	InitializeClass(BoxSizer);
	InitializeClass(StaticBoxSizer);
	InitializeClass(StdDialogButtonSizer);
	InitializeClass(GridSizer);
	InitializeClass(FlexGridSizer);
	InitializeClass(GridBagSizer);
	InitializeClass(SizerItem);
	InitializeClass(GBSizerItem);
	InitializeClass(SockAddress);
	InitializeClass(IPaddress);
	InitializeClass(IPV4address);
	InitializeClass(SocketBase);
	InitializeClass(DatagramSocket);
	InitializeClass(SocketClient);
	InitializeClass(Protocol);
	InitializeClass(FTP);
	InitializeClass(HTTP);
	InitializeClass(SocketServer);
	InitializeClass(Sound);
	InitializeClass(StringTokenizer);
	InitializeClass(SystemOptions);
	InitializeClass(ToolTip);
	InitializeClass(URI);
	InitializeClass(URL);
	InitializeClass(Variant);
	InitializeClass(VariantData);
	InitializeClass(XmlDocument);
	InitializeClass(XmlResource);
	InitializeClass(XmlResourceHandler);
	InitializeClass(ObjectRefData);
	InitializeClass(PenList);
	InitializeClass(PlatformInfo);
	InitializeClass(Point);
	InitializeClass(RealPoint);
	...
	InitializeClass(RichTextAttr);
	InitializeClass(RichTextParagraphLayoutBox);
	InitializeClass(RichTextBuffer);
	InitializeClass(RichTextRange);
	InitializeClass(Semaphore);
	InitializeClass(SingleInstanceChecker);
	InitializeClass(Size);
	InitializeClass(SizerFlags);
	InitializeClass(SplitterRenderParams);
	InitializeClass(StackFrame);
	InitializeClass(StackWalker);
	InitializeClass(StandardPaths);
	InitializeClass(StopWatch);
	InitializeClass(StreamBase);
	InitializeClass(InputStream);
	InitializeClass(FFileInputStream);
	InitializeClass(FileInputStream);
	InitializeClass(FilterInputStream);
	InitializeClass(ArchiveInputStream);
	InitializeClass(TarInputStream);
	InitializeClass(ZipInputStream);
	InitializeClass(BufferedInputStream);
	InitializeClass(ZlibInputStream);
	InitializeClass(MemoryInputStream);
	InitializeClass(SocketInputStream);
	InitializeClass(StringInputStream);
	InitializeClass(OutputStream);
	InitializeClass(CountingOutputStream);
	InitializeClass(FFileOutputStream);
	InitializeClass(FFileStream);
	InitializeClass(FileOutputStream);
	InitializeClass(FileStream);
	InitializeClass(FilterOutputStream);
	InitializeClass(ArchiveOutputStream);
	InitializeClass(TarOutputStream);
	InitializeClass(ZipOutputStream);
	InitializeClass(BufferedOutputStream);
	InitializeClass(ZlibOutputStream);
	InitializeClass(MemoryOutputStream);
	InitializeClass(SocketOutputStream);
	InitializeClass(StringOutputStream);
	InitializeClass(TempFileOutputStream);
	InitializeClass(StreamBuffer);
	InitializeClass(String);
	InitializeClass(StringBuffer);
	InitializeClass(StringBufferLength);
	InitializeClass(SystemSettings);
	InitializeClass(TempFile);
	InitializeClass(TextAttr);
	InitializeClass(TextAttrEx);
	InitializeClass(TextFile);
	InitializeClass(TextInputStream);
	InitializeClass(TextOutputStream);
	InitializeClass(Thread);
	InitializeClass(ThreadHelper);
	InitializeClass(TimeSpan);
	InitializeClass(TipProvider);
	InitializeClass(TreeItemId);
	InitializeClass(WindowUpdateLocker);
	InitializeClass(WindowDisabler);
	InitializeClass(XmlNode);
	InitializeClass(XmlProperty);
	InitializeClass(ZipNotifier);
	InitializeClass(NativeEncodingInfo);
	InitializeClass(NativeFontInfo);
	InitializeClass(FileTypeInfo);
	InitializeClass(ArchiveNotifier);
	InitializeClass(ArtClient);
	InitializeClass(BMPHandler);
	InitializeClass(GIFHandler);
	InitializeClass(JPEGHandler);
	InitializeClass(PCXHandler);
	InitializeClass(PNGHandler);
	InitializeClass(PNMHandler);
	InitializeClass(TGAHandler);
	InitializeClass(TIFFHandler);
	InitializeClass(XPMHandler);
	InitializeClass(AppConsole);
	InitializeClass(GridCellCoords);
	InitializeClass(GridCellAttrProvider);
	InitializeClass(PageSetupData);
	InitializeClass(ToolBarToolBase);
	InitializeClass(HtmlWindowInterface);
	InitializeClass(HtmlTagsCache);
	InitializeClass(HtmlEntitiesParser);
	InitializeClass(RichTextObject);
	InitializeClass(RichTextImageBlock);
	InitializeClass(RichTextRenderer);
	InitializeClass(RichTextAction);
...
{
	//wxImage *pImage = new wxImage(pObjImage->GetWidth(), pObjImage->GetHeight(), false);
	do {
