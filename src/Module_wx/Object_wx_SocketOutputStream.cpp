...
Gura_ImplementFunction(SocketOutputStream)
{
	...
	Object_wx_SocketOutputStream *pObj = Object_wx_SocketOutputStream::GetSelfObj(args);
	if (pObj == NULL) {
...
void Object_wx_SocketOutputStream::OnModuleEntry(Environment &env, Signal sig)
{
