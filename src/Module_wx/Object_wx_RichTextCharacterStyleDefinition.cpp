...
Gura_ImplementFunction(RichTextCharacterStyleDefinition)
{
	...
	Object_wx_RichTextCharacterStyleDefinition *pObj = Object_wx_RichTextCharacterStyleDefinition::GetSelfObj(args);
	if (pObj == NULL) {
...
String Object_wx_RichTextCharacterStyleDefinition::ToString(Signal sig, bool exprFlag)
{
