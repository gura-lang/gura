...
public:
	...
	Gura_DeclareSymbol(light_blue);
	Gura_DeclareSymbol(light_green);
	Gura_DeclareSymbol(light_aqua);
	Gura_DeclareSymbol(light_red);
	Gura_DeclareSymbol(light_purple);
	Gura_DeclareSymbol(light_yellow);
