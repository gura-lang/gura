...
GURA_DLLDECLARE extern ValueType VTYPE_optimizer;
...
GURA_DLLDECLARE extern ValueType VTYPE_gear_at_averagepool1d;
GURA_DLLDECLARE extern ValueType VTYPE_gear_at_averagepool2d;
GURA_DLLDECLARE extern ValueType VTYPE_gear_at_averagepool3d;
...
public:
	...
	Gura_DeclareVTYPE(gear_at_averagepool1d);
	Gura_DeclareVTYPE(gear_at_averagepool2d);
	Gura_DeclareVTYPE(gear_at_averagepool3d);
