...
GURA_DLLDECLARE extern ValueType VTYPE_array_at_ushort;
GURA_DLLDECLARE extern ValueType VTYPE_array_at_int;
GURA_DLLDECLARE extern ValueType VTYPE_array_at_uint;
...
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_char;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_uchar;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_short;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_ushort;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_int;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_uint;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_int32;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_uint32;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_int64;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_uint64;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_float;
GURA_DLLDECLARE extern ValueType VTYPE_matrix_at_double;
...
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_char;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_uchar;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_short;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_ushort;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_int;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_uint;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_int32;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_uint32;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_int64;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_uint64;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_float;
GURA_DLLDECLARE extern ValueType VTYPE_tensor_at_double;
...
public:
	...
	Gura_DeclareVTYPE(array_at_ushort);
	Gura_DeclareVTYPE(array_at_int);
	Gura_DeclareVTYPE(array_at_uint);
	...
	Gura_DeclareVTYPE(matrix_at_char);
	Gura_DeclareVTYPE(matrix_at_uchar);
	Gura_DeclareVTYPE(matrix_at_short);
	Gura_DeclareVTYPE(matrix_at_ushort);
	Gura_DeclareVTYPE(matrix_at_int);
	Gura_DeclareVTYPE(matrix_at_uint);
	Gura_DeclareVTYPE(matrix_at_int32);
	Gura_DeclareVTYPE(matrix_at_uint32);
	Gura_DeclareVTYPE(matrix_at_int64);
	Gura_DeclareVTYPE(matrix_at_uint64);
	Gura_DeclareVTYPE(matrix_at_float);
	Gura_DeclareVTYPE(matrix_at_double);
	...
	Gura_DeclareVTYPE(tensor_at_char);
	Gura_DeclareVTYPE(tensor_at_uchar);
	Gura_DeclareVTYPE(tensor_at_short);
	Gura_DeclareVTYPE(tensor_at_ushort);
	Gura_DeclareVTYPE(tensor_at_int);
	Gura_DeclareVTYPE(tensor_at_uint);
	Gura_DeclareVTYPE(tensor_at_int32);
	Gura_DeclareVTYPE(tensor_at_uint32);
	Gura_DeclareVTYPE(tensor_at_int64);
	Gura_DeclareVTYPE(tensor_at_uint64);
	Gura_DeclareVTYPE(tensor_at_float);
	Gura_DeclareVTYPE(tensor_at_double);
