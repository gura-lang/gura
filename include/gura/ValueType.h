...
GURA_DLLDECLARE extern ValueType VTYPE_array_int32;
GURA_DLLDECLARE extern ValueType VTYPE_array_uint32;
GURA_DLLDECLARE extern ValueType VTYPE_array_int64;
GURA_DLLDECLARE extern ValueType VTYPE_array_uint64;
...
public:
	...
	Gura_DeclareVTYPE(array_int32);
	Gura_DeclareVTYPE(array_uint32);
	Gura_DeclareVTYPE(array_int64);
	Gura_DeclareVTYPE(array_uint64);
