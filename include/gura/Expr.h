...
public:
	...
	virtual bool GenerateScript(Signal sig, SimpleStream &stream, bool oneLineFlag) const;
...
public:
	...
	bool GenerateScript(Signal sig, SimpleStream &stream, bool oneLineFlag, const char *sep) const;
