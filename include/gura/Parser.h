...
public:
	...
	~Parser();
	void InitStack();
	bool ParseChar(Environment &env, char ch, ExprOwner &exprOwner, const Expr *pExprParent);
...
private:
	...
	virtual Expr *FeedElement(Environment &env, const Element &elem, ExprOwner &exprOwner, const Expr *pExprParent);
